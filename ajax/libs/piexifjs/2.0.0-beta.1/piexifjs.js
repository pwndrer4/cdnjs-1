(function (global, factory) {
    ...
    var _exceptions = /*#__PURE__*/Object.freeze({
        ValueConvertError: ValueConvertError
    });
                ...
                if (t == 1) { // BYTE
                    ...
                    if (length > 1) {
                        ...
                        for (let x = 0; x < length; x++) {
                            data.push([unpack(this.endianMark + "L", this.tiftag.slice(pointer + x * 8, pointer + 4 + x * 8))[0],
                    ...
                    if (length > 1) {
                        ...
                        data = [unpack(this.endianMark + "l", this.tiftag.slice(pointer, pointer + 4))[0],
                            unpack(this.endianMark + "l", this.tiftag.slice(pointer + 4, pointer + 8))[0]
                        ];
                    }
                }
    ...
    var _utils = /*#__PURE__*/Object.freeze({
        ...
        btoa: btoa,
        _packByte: _packByte,
        _packShort: _packShort,
        _packLong: _packLong,
        copy: copy,
        getThumbnail: getThumbnail,
        _valueToBytes: _valueToBytes,
        _toByte: _toByte,
        _toAscii: _toAscii,
        _toShort: _toShort,
        _toLong: _toLong,
        _toRational: _toRational,
        _toUndefined: _toUndefined,
        _toSRational: _toSRational,
    ...
    var _helper = /*#__PURE__*/Object.freeze({
        GPSHelper: GPSHelper
    });
    ...
    const load = (binary) => {
        ...
        let exifObj = {};
        let exifReader = new ExifReader(exifBinary);
        ...
        let gpsIfd = null;
        let thumbnail = null;
        let pointer = unpack(exifReader.endianMark + "L", exifReader.tiftag.slice(4, 8))[0];
    ...
    const dump = (originalExifObj) => {
        const TIFF_HEADER_LENGTH = 8;
        let exifObj = copy(originalExifObj);
        ...
        let zerothIfdSet = dictToBytes(zerothIfd, "0th", 0);

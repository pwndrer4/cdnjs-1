...
(function (global, factory) {
  ...
  function useField(name, rules, opts) {
      ...
      function resetField(state) {
          ...
          resetValidationState(state === null || state === void 0 ? void 0 : state.value);
  ...
  function useValidationState({ name, initValue, form, type, valueProp, }) {
      ...
      const formInitialValues = vue.inject(FormInitialValues, undefined);
      ...
      function resetValidationState(newValue) {
          var _a;
          value.value = (_a = newValue !== null && newValue !== void 0 ? newValue : getFromPath(vue.unref(formInitialValues), vue.unref(name))) !== null && _a !== void 0 ? _a : initValue;
          errors.value = [];
          resetMeta();
      }
      return {

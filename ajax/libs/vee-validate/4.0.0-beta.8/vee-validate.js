...
(function (global, factory) {
  ...
  const Field = vue.defineComponent({
      ...
      setup(props, ctx) {
          ...
          const { errors, value, errorMessage, validate: validateField, handleChange, handleBlur, handleInput, reset, meta, checked, } = useField(props.name, rules, {
  ...
  function useForm(opts) {
      ...
      const errors = vue.computed(() => {
          return activeFields.value.reduce((acc, field) => {
              ...
              if (Array.isArray(fieldsById.value[field.name])) {
                  ...
                  message = unwrap((group.find((f) => unwrap(f.checked)) || field).errorMessage);
              }
              else {
      ...
      const initialValues = vue.computed(() => {
          const values = (opts === null || opts === void 0 ? void 0 : opts.initialValues) || {};
          if (vue.isRef(values)) {
              return values.value;
          }
          return values;
  ...
  function useFormMeta(fields, initialValues) {
      return vue.computed(() => {
          ...
          return Object.assign({ initialValues: unwrap(initialValues) }, flags);
      });
  }

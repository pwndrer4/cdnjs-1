...
(function (global, factory) {
  ...
  function useValidationState({ name, initValue, form, type, valueProp, }) {
      ...
      const initialValue = (_a = getFromPath(vue.unref(vue.inject(FormInitialValues, {})), name)) !== null && _a !== void 0 ? _a : initValue;
  ...
  function injectWithSelf(symbol, def = undefined) {
      ...
      return vue.inject(symbol, def) || (vm === null || vm === void 0 ? void 0 : vm.provides[symbol]);
  }
  ...
  function useForm(opts) {
      ...
      const activeFields = vue.computed(() => {
          return fields.value.filter(field => !vue.unref(field.disabled));
      });

...
(function (global, factory) {
  ...
  function useField(name, rules, opts) {
      ...
      const { initialValue, validateOnMount, bails, type, valueProp, label, validateOnValueUpdate } = normalizeOptions(vue.unref(name), opts);
  ...
  function useValidationState({ name, initValue, form, type, valueProp, }) {
      ...
      const initialValue = (_a = getFromPath(vue.unref(vue.inject(FormInitialValues, undefined)), vue.unref(name))) !== null && _a !== void 0 ? _a : initValue;
  ...
  const Field = vue.defineComponent({
      ...
      setup(props, ctx) {
          ...
          const { errors, value, errorMessage, validate: validateField, handleChange, handleBlur, handleInput, setDirty, setTouched, reset, meta, checked, } = useField(name, rules, {
          ...
          return () => {
              ...
              if (tag) {
                  return vue.h(tag, Object.assign(Object.assign({}, ctx.attrs), slotProps.field), children);
              }
              return children;
          };
      },

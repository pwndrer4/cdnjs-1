...
define("@ember/-internals/utils/index", ["exports", "@ember/polyfills", "@ember/debug"], function (_exports, _polyfills, _debug) {
  ...
  */
  ...
  /* EMBER_METAL_TRACKED_PROPERTIES */
      ...
      var getPropertyDescriptor = function getPropertyDescriptor(obj, keyName) {
        var current = obj;
...
define("@glimmer/compiler", ["exports", "node-module", "@glimmer/util", "@glimmer/wire-format", "@glimmer/syntax"], function (_exports, _nodeModule, _util, _wireFormat, _syntax) {
  "use strict";
  ...
  /*#__PURE__*/
  function (_Block2) {
    _inheritsLoose(TemplateBlock, _Block2);
  ...
  /*#__PURE__*/
  function (_Block3) {
    _inheritsLoose(ComponentBlock, _Block3);
...
define("@glimmer/syntax", ["exports", "simple-html-tokenizer", "@glimmer/util", "handlebars"], function (_exports, _simpleHtmlTokenizer, _util, _handlebars) {
  "use strict";

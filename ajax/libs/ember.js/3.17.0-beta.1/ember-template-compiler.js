...
define("@glimmer/compiler", ["exports", "ember-babel", "node-module", "@glimmer/util", "@glimmer/wire-format", "@glimmer/syntax"], function (_exports, _emberBabel, _nodeModule, _util, _wireFormat, _syntax) {
  ...
  function () {
    ...
    _proto10.getFreeWithContext = function getFreeWithContext(_ref8) {
      var head = _ref8[0],
          context = _ref8[1];
      this.pushValue([26
      /* GetContextualFree */
  ...
  function () {
    ...
    _proto11.getVar = function getVar(_ref9) {
      var name = _ref9[0],
          context = _ref9[1];
    ...
    _proto11.block = function block(_ref10) {
      var template = _ref10[0],
          inverse = _ref10[1];
    ...
    _proto11.openElement = function openElement(_ref11) {
      var element = _ref11[0],
          simple = _ref11[1];
    ...
    _proto11.staticAttr = function staticAttr(_ref12) {
      var name = _ref12[0],
          ns = _ref12[1];
      return ['staticAttr', [name, ns]];
    };

    _proto11.trustingAttr = function trustingAttr(_ref13) {
      var name = _ref13[0],
          ns = _ref13[1];
      return ['trustingAttr', [name, ns]];
    };

    _proto11.dynamicAttr = function dynamicAttr(_ref14) {
      var name = _ref14[0],
          ns = _ref14[1];
      return ['dynamicAttr', [name, ns]];
    };

    _proto11.componentAttr = function componentAttr(_ref15) {
      var name = _ref15[0],
          ns = _ref15[1];
      return ['componentAttr', [name, ns]];
    };

    _proto11.trustingComponentAttr = function trustingComponentAttr(_ref16) {
      var name = _ref16[0],
          ns = _ref16[1];
  ...
  function () {
    ...
    _proto12.startProgram = function startProgram(_ref18) {
      var program = _ref18[0];
    ...
    _proto12.startBlock = function startBlock(_ref19) {
      var program = _ref19[0];
      this.templateId++;
    ...
    _proto12.text = function text(_ref20) {
      var action = _ref20[0];
      this.opcode(['text', action.chars], action);
    };

    _proto12.comment = function comment(_ref21) {
      var action = _ref21[0];
      this.opcode(['comment', action.value], action);
    };

    _proto12.openElement = function openElement(_ref22) {
      var action = _ref22[0];
    ...
    _proto12.closeElement = function closeElement(_ref23) {
      var action = _ref23[0];
    ...
    _proto12.attribute = function attribute(_ref24, isComponent) {
      var action = _ref24[0];
    ...
    _proto12.modifier = function modifier(_ref25) {
      var action = _ref25[0];
    ...
    _proto12.mustache = function mustache(_ref26) {
      var _mustache = _ref26[0];
    ...
    _proto12.block = function block(_ref27) {
      var action
      /*, index, count*/
      = _ref27[0];
  ...
  function isSimplePath(_ref28) {
    var parts = _ref28.parts;
  ...
  function buildElement(_ref30, symbols) {
...
define("@glimmer/syntax", ["exports", "ember-babel", "@glimmer/util", "simple-html-tokenizer", "handlebars"], function (_exports, _emberBabel, _util, _simpleHtmlTokenizer, _handlebars) {
  ...
  function () {
    ...
    */
    ...
    var _proto3 = Printer.prototype;

    _proto3.handledByOverride = function handledByOverride(node, ensureLeadingWhitespace) {
    ...
    _proto3.Node = function Node(node) {
      switch (node.type) {
    ...
    _proto3.Expression = function Expression(expression) {
    ...
    _proto3.Literal = function Literal(literal) {
      switch (literal.type) {
        case 'StringLiteral':
    ...
    _proto3.TopLevelStatement = function TopLevelStatement(statement) {
    ...
    _proto3.Block = function Block(block) {
      /*
    ...
    _proto3.TopLevelStatements = function TopLevelStatements(statements) {
      var _this2 = this;
    ...
    _proto3.ElementNode = function ElementNode(el) {
    ...
    _proto3.OpenElementNode = function OpenElementNode(el) {
      var _this3 = this;
    ...
    _proto3.CloseElementNode = function CloseElementNode(el) {
    ...
    _proto3.AttrNode = function AttrNode(attr) {
    ...
    _proto3.AttrNodeValue = function AttrNodeValue(value) {
      if (value.type === 'TextNode') {
        this.buffer += '"';
    ...
    _proto3.TextNode = function TextNode(text, isAttr) {
    ...
    _proto3.BlockParams = function BlockParams(blockParams) {
      this.buffer += " as |" + blockParams.join(' ') + "|";
    };

    _proto3.PartialStatement = function PartialStatement(partial) {
    ...
    _proto3.ConcatStatement = function ConcatStatement(concat) {
      var _this4 = this;
    ...
    _proto3.MustacheCommentStatement = function MustacheCommentStatement(comment) {
    ...
    _proto3.ElementModifierStatement = function ElementModifierStatement(mod) {
    ...
    _proto3.CommentStatement = function CommentStatement(comment) {
      if (this.handledByOverride(comment)) {
        return;
      }
    ...
    _proto3.PathExpression = function PathExpression(path) {
    ...
    _proto3.SubExpression = function SubExpression(sexp) {
    ...
    _proto3.Params = function Params(params) {
      var _this5 = this;
    ...
    _proto3.Hash = function Hash(hash) {
      var _this6 = this;
    ...
    _proto3.HashPair = function HashPair(pair) {
    ...
    _proto3.StringLiteral = function StringLiteral(str) {
    ...
    _proto3.BooleanLiteral = function BooleanLiteral(bool) {
    ...
    _proto3.NumberLiteral = function NumberLiteral(number) {
    ...
    _proto3.UndefinedLiteral = function UndefinedLiteral(node) {
    ...
    _proto3.NullLiteral = function NullLiteral(node) {
      if (this.handledByOverride(node)) {
        return;
      }
    ...
    _proto3.print = function print(node) {
  ...
  function () {
    ...
    var _proto4 = Walker.prototype;

    _proto4.visit = function visit(node, callback) {
      if (!node) {
        return;
      }
    ...
    _proto4.children = function children(node, callback) {
      var type;
  ...
  function (_HandlebarsNodeVisito) {
    ...
    var _proto5 = TokenizerEventHandlers.prototype;
    ...
    _proto5.beginComment = function beginComment() {
    ...
    _proto5.appendToCommentData = function appendToCommentData(char) {
      this.currentComment.value += char;
    };

    _proto5.finishComment = function finishComment() {
      this.currentComment.loc.end = b.pos(this.tokenizer.line, this.tokenizer.column);
      appendChild(this.currentElement(), this.currentComment);
    } // Data
    ;

    _proto5.beginData = function beginData() {
    ...
    _proto5.appendToData = function appendToData(char) {
      this.currentData.chars += char;
    };

    _proto5.finishData = function finishData() {
      this.currentData.loc.end = b.pos(this.tokenizer.line, this.tokenizer.column);
      appendChild(this.currentElement(), this.currentData);
    } // Tags - basic
    ;

    _proto5.tagOpen = function tagOpen() {
      this.tagOpenLine = this.tokenizer.line;
      this.tagOpenColumn = this.tokenizer.column;
    };

    _proto5.beginStartTag = function beginStartTag() {
      this.currentNode = {
        type: 'StartTag',
        name: '',
        attributes: [],
    ...
    _proto5.beginEndTag = function beginEndTag() {
      this.currentNode = {
        type: 'EndTag',
        name: '',
        attributes: [],
    ...
    _proto5.finishTag = function finishTag() {
    ...
    _proto5.finishStartTag = function finishStartTag() {
    ...
    _proto5.finishEndTag = function finishEndTag(isVoid) {
      var tag = this.currentTag;
    ...
    _proto5.markTagAsSelfClosing = function markTagAsSelfClosing() {
      this.currentTag.selfClosing = true;
    } // Tags - name
    ;

    _proto5.appendToTagName = function appendToTagName(char) {
      this.currentTag.name += char;
    } // Tags - attributes
    ;

    _proto5.beginAttribute = function beginAttribute() {
      var tag = this.currentTag;
    ...
    _proto5.appendToAttributeName = function appendToAttributeName(char) {
      this.currentAttr.name += char;
    };

    _proto5.beginAttributeValue = function beginAttributeValue(isQuoted) {
      this.currentAttr.isQuoted = isQuoted;
      this.currentAttr.valueStartLine = this.tokenizer.line;
      this.currentAttr.valueStartColumn = this.tokenizer.column;
    };

    _proto5.appendToAttributeValue = function appendToAttributeValue(char) {
    ...
    _proto5.finishAttributeValue = function finishAttributeValue() {
    ...
    _proto5.reportSyntaxError = function reportSyntaxError(message) {
...
define("ember-template-compiler/lib/plugins/index", ["exports", "ember-template-compiler/lib/plugins/assert-if-helper-without-arguments", "ember-template-compiler/lib/plugins/assert-input-helper-without-block", "ember-template-compiler/lib/plugins/assert-local-variable-shadowing-helper-invocation", "ember-template-compiler/lib/plugins/assert-reserved-named-arguments", "ember-template-compiler/lib/plugins/assert-splattribute-expression", "ember-template-compiler/lib/plugins/deprecate-send-action", "ember-template-compiler/lib/plugins/transform-action-syntax", "ember-template-compiler/lib/plugins/transform-attrs-into-args", "ember-template-compiler/lib/plugins/transform-component-invocation", "ember-template-compiler/lib/plugins/transform-each-in-into-each", "ember-template-compiler/lib/plugins/transform-each-track-array", "ember-template-compiler/lib/plugins/transform-has-block-syntax", "ember-template-compiler/lib/plugins/transform-in-element", "ember-template-compiler/lib/plugins/transform-link-to", "ember-template-compiler/lib/plugins/transform-old-class-binding-syntax", "ember-template-compiler/lib/plugins/transform-quoted-bindings-into-just-bindings", "ember-template-compiler/lib/plugins/transform-wrap-mount-and-outlet", "@ember/deprecated-features"], function (_exports, _assertIfHelperWithoutArguments, _assertInputHelperWithoutBlock, _assertLocalVariableShadowingHelperInvocation, _assertReservedNamedArguments, _assertSplattributeExpression, _deprecateSendAction, _transformActionSyntax, _transformAttrsIntoArgs, _transformComponentInvocation, _transformEachInIntoEach, _transformEachTrackArray, _transformHasBlockSyntax, _transformInElement, _transformLinkTo, _transformOldClassBindingSyntax, _transformQuotedBindingsIntoJustBindings, _transformWrapMountAndOutlet, _deprecatedFeatures) {
  "use strict";
      ...
      visitor: {
        BlockStatement: function BlockStatement(node) {
          ...
          if (node.path.original === 'in-element') {
            ...
            hash.pairs.forEach(function (pair) {
              if (pair.key === 'insertBefore') {
                (true && !(pair.value.type === 'NullLiteral') && (0, _debug.assert)("Can only pass a null literal to insertBefore in -in-element, received: " + JSON.stringify(pair.value), pair.value.type === 'NullLiteral'));
                hasInsertBefore = true;
              }
            });
            ...
            if (!hasInsertBefore) {
              var undefinedLiteral = b.literal('UndefinedLiteral', undefined);
              var nextSibling = b.pair('insertBefore', undefinedLiteral);

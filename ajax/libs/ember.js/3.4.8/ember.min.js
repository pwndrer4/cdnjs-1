...
o=i.pop()}}return[t,n,i,o=parseInt(o,10),r]}var _=0,E=0,w=0,R=0,C=0,O=0,T=0,A=0,S=0,k=0,P=0,N=0,x=0,M=0,I=0,L=0,D=0,j=0,B=0,F=0,U=0,z=function(){function e(e,t){var n=this
this.DEBUG=!1
...
e.prototype.scheduleIterable=function(e,t){S++
...
e.prototype.setTimeout=function(){N++
...
e.prototype.debounce=function(){I++
...
this._autorun=e()};(0,t.createClass)(e,[{key:"counters",get:function(){return{begin:E,end:w,events:{begin:R,end:0},autoruns:{created:j,completed:B},run:C,join:O,defer:T,schedule:A,scheduleIterable:S,deferOnce:k,scheduleOnce:P,setTimeout:N,later:x,throttle:M,debounce:I,cancelTimers:L,cancel:D,loops:{total:F,nested:U}}}},{key:"defaultQueue",get:function(){return this._defaultQueue}}])
return e}()
z.Queue=f
e.default=z
e.buildPlatform=i})

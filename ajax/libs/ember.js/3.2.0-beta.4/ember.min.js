...
return e}()
function w(e){return C(e)?"":String(e)}function C(e){return null===e||void 0===e||"function"!=typeof e.toString}function k(e){return"object"==typeof e&&null!==e&&"function"==typeof e.toHTML}function E(e){return"object"==typeof e&&null!==e&&"number"==typeof e.nodeType}function R(e){return"string"==typeof e}var A=function(e){(0,t.inherits)(n,e)
...
if(e!==t){var n=void 0;(n=C(e)?"":R(e)?e:String(e))!==t&&(this.node.nodeValue=this.lastValue=n)}}
return n}(a),S=function(e){(0,t.inherits)(n,e)
...
return n}(m),O=function(){function e(e){this.inner=e
this.tag=e.tag}e.prototype.value=function(){var e,t=this.inner.value()
return function(e){return R(e)||C(e)||"boolean"==typeof e||"number"==typeof e}(t)?1:(e=t)&&e[y]?0:k(t)?3:function(e){return E(e)&&11===e.nodeType}(t)?4:E(t)?5:1}
return e}()
s.add(28,function(e){var t=e.stack.pop().value(),n=C(t)?"":String(t)
e.elements().appendDynamicHTML(n)})
s.add(29,function(e){var t=e.stack.pop().value().toHTML(),n=C(t)?"":t
e.elements().appendDynamicHTML(n)})
s.add(32,function(e){var t=e.stack.pop(),n=t.value(),i=C(n)?"":String(n),o=e.elements().appendDynamicText(i);(0,r.isConst)(t)||e.updateWith(new A(o,t,i))})
...
var T=function(e){(0,t.inherits)(n,e)
function n(n){var r=(0,t.possibleConstructorReturn)(this,e.call(this))
r.type="assert"
r.tag=n.tag
r.cache=n
...
e.updateWith(new T(t))}if((0,r.isConst)(o))a=o.value()
else{a=(n=new r.ReferenceCache(o)).peek()
e.updateWith(new T(n))}e.elements().pushRemoteElement(s,u,a)})
...
var j=function(e){(0,t.inherits)(n,e)
function n(n,r,i){var o=(0,t.possibleConstructorReturn)(this,e.call(this))
o.tag=n
o.manager=r
o.modifier=i
...
return n}(a)
function M(e,t,n){return e.lookupComponentDefinition(t,n)}var I=function(){function e(e,t,n,r){this.inner=e
this.resolver=t
this.meta=n
this.args=r
this.tag=e.tag
...
var r=null
b(n)?r=n:"string"==typeof n&&n&&(r=M(this.resolver,n,this.meta))
r=this.curry(r)
this.lastValue=n
...
e.loadValue(i.Register.v0,new I(o,u,a,s))})
...
s.add(83,function(e){e.loadValue(i.Register.t0,new z)})
...
var z=function(){function e(){this.attributes=(0,n.dict)()
...
function U(e,t,n,r,i){var o=n.table.symbols.indexOf(e),s=r.get(t);-1!==o&&i.scope().bindBlock(o+1,s)
n.lookup&&(n.lookup[e]=s)}s.add(3,function(e,t){var n=t.op1,r=e.fetchValue(n),i=e.stack.peek().blocks
U("&attrs","attrs",r,i,e)
U("&inverse","else",r,i,e)
U("&default","main",r,i,e)})
...
var G=function(e,t){this.element=e
...
function _e(e,t){return-1!==e.indexOf(t)}function we(e,t){return(null===e||_e(ge,e))&&_e(ye,t)}function Ce(e,t){return null!==e&&(_e(ve,e)&&_e(be,t))}function ke(e,t){return we(e,t)||Ce(e,t)}function Ee(e,t,n,r){var i,o=null
if(null===r||void 0===r)return r
if(k(r))return r.toHTML()
o=t?t.tagName.toUpperCase():null
var s=w(r)
if(we(o,n)){i=e.protocolForURL(s)
if(_e(me,i))return"unsafe:"+s}return Ce(o,n)?"unsafe:"+s:s}function Re(e,t){var n,r,i,o,s=void 0,a=void 0
if(t in e){a=t
...
return"attr"===s?Oe(r,a,i):function(e,t,n){if(ke(e,t))return new Ne(t,n)
...
return new Pe(t,n)}(r,a,i)}function Oe(e,t,n){return ke(e,t)?new je(n):new xe(n)}var Te=function(e){this.attribute=e},xe=function(e){(0,t.inherits)(n,e)
function n(){return(0,t.possibleConstructorReturn)(this,e.apply(this,arguments))}n.prototype.set=function(e,t){var n,r,i,o=Ie(t)
if(null!==o){r=(n=this.attribute).name,i=n.namespace
e.__setAttribute(r,o,i)}}
n.prototype.update=function(e){var t=Ie(e),n=this.attribute,r=n.element,i=n.name
null===t?r.removeAttribute(i):r.setAttribute(i,t)}
return n}(Te),Pe=function(e){(0,t.inherits)(n,e)
...
return n}(Te),Ne=function(e){(0,t.inherits)(n,e)
function n(){return(0,t.possibleConstructorReturn)(this,e.apply(this,arguments))}n.prototype.set=function(t,n,r){var i=this.attribute,o=Ee(r,i.element,i.name,n)
e.prototype.set.call(this,t,o,r)}
n.prototype.update=function(t,n){var r=this.attribute,i=Ee(n,r.element,r.name,t)
...
n.prototype.update=function(t,n){var r=this.attribute,i=Ee(n,r.element,r.name,t)
e.prototype.update.call(this,i,n)}
return n}(xe),Le=function(e){(0,t.inherits)(n,e)
...
n!==r&&(t.value=r)}
return n}(Pe),Me=function(e){(0,t.inherits)(n,e)
...
t.selected=!!e}
return n}(Pe)
function Ie(e){return!1===e||void 0===e||null===e||void 0===e.toString?null:!0===e?"":"function"==typeof e?null:String(e)}var De=function(){function e(e,t,n,r){this.slots=e
this.callerScope=t
this.evalScope=n
...
this._transaction=null
e.commit()}
e.prototype.attributeFor=function(e,t){return Se(e,t,arguments.length>3&&void 0!==arguments[3]?arguments[3]:null)};(0,t.createClass)(e,[{key:"transaction",get:function(){return this._transaction}}])
return e}(),ze=function(e){(0,t.inherits)(n,e)
function n(n){var r
if(!n){r=window.document
n={appendOperations:new de(r),updateOperations:new ce(r)}}return(0,t.possibleConstructorReturn)(this,e.call(this,n))}return n}(Be),Ue=function(){function e(e,t,n,r){var i=arguments.length>4&&void 0!==arguments[4]?arguments[4]:-1,o=arguments.length>5&&void 0!==arguments[5]?arguments[5]:-1
this.stack=e
this.heap=t
this.program=n
this.externs=r
...
e.prototype.pushUpdatableBlock=function(){return this.pushBlockTracker(new Qe(this.element))}
e.prototype.pushBlockList=function(e){return this.pushBlockTracker(new Ge(this.element,e))}
...
this.popElement()}
e.prototype.pushElement=function(e,t){this.cursorStack.push(new G(e,t))}
...
ee(this)}
return n}(We),Qe=function(e){(0,t.inherits)(n,e)
...
this.nesting=0
return r}
return n}(We),Ge=function(){function e(e,t){this.parent=e
this.boundList=t
this.parent=e
...
this.args=new st
this.inner=new Ue(Xe.empty(),this.heap,e.program,{debugBefore:function(e){return s.debugBefore(o,e,e.type)},debugAfter:function(e,t){s.debugAfter(o,e,e.type,t)}})}e.prototype.fetch=function(e){this.stack.push(this[i.Register[e]])}
...
e.initial=function(t,r,i,o,s,a){var u=t.heap.scopesizeof(a),l=new e({program:t,env:r},De.root(i,u),o,s)
l.pc=l.heap.getaddr(a)
l.updatingOpcodeStack.push(new n.LinkedList)
return l}
e.empty=function(t,r,i){var o={get:function(){return p},set:function(){return p},child:function(){return o}},s=new e({program:t,env:r},De.root(p,0),o,i)
...
e.prototype.commitCacheGroup=function(){var e=new N("END"),t=this.updating(),i=this.cacheGroups.pop(),o=i?t.nextNode(i):t.head(),s=t.tail(),a=(0,r.combineSlice)(new n.ListSlice(o,s)),u=new x(a,e)
t.insertBefore(u,o)
t.append(new P(u))
t.append(e)}
...
return e}
e.prototype.pushRootScope=function(e,t){var n=De.sized(e)
...
return e}(),vt=function(){function e(e){this.vm=e}e.prototype.next=function(){return this.vm.next()}
...
return o}return n}(G),_t=function(e){(0,t.inherits)(r,e)
...
this.blockDepth--
var n=e.candidate
if(null!==n)if(wt(n)&&Ct(n)===t){e.candidate=this.remove(n)
...
if(n&&Et(n)){t=(e=n).nextSibling
for(;t&&!Et(t);)t=t.nextSibling
...
if(n&&kt(n)&&function(e,t){if(e.namespaceURI===re)return e.tagName===t
return e.tagName===t.toUpperCase()}(n,t)){this.unmatchedAttributes=[].slice.call(n.attributes)
return n}if(n){if(kt(n)&&"TBODY"===n.tagName){this.pushElement(n,null)
...
return t&&t[1]?Number(t[1]):null}function kt(e){return 1===e.nodeType}function Et(e){return 8===e.nodeType&&"%glmr%"===e.nodeValue}function Rt(e){return 8===e.nodeType&&"% %"===e.nodeValue}function At(e,t){var n,r
...
this.isDestroyed=!0}
e.prototype.reset=function(e){this.isDestroyed||(void 0===e?p(this):function(e,t){var n=e.cache[t]
...
void 0!==t&&l(e,t,r)
void 0!==n&&l(e,n,r)
return r}(e,n.getTypeInjections(r),n.getInjections(t))}function p(e){(function(e){var t,n,r=e.cache,i=Object.keys(r)
for(t=0;t<i.length;t++)(n=r[i[t]]).destroy&&n.destroy()})(e)
e.cache=(0,n.dictionary)(null)
e.factoryManagerCache=(0,n.dictionary)(null)}var h=new WeakMap,f=function(){function e(e,t,n,r){this.container=e
this.owner=e.owner
this.class=t
this.fullName=n
...
if(void 0===n.destroy)return new H(n.compute,t.capture())
e.newDestroyable(n)
return V.create(n,t.capture())}:null}
...
St[s]=n
a.setName(n,s)
for(var u in n)if(Ct.call(n,u)){i=n[u]
t[o]=u
...
n in t.context.lookup&&e===t.context.lookup[n]&&(t.context.lookup[n]=void 0)}
...
e.getName=function(e){return C.get(e)}

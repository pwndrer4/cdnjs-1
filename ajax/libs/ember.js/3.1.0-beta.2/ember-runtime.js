...
enifed('ember-metal', ['exports', 'ember-environment', 'ember-utils', 'ember-debug', 'ember/features', 'ember-babel', '@glimmer/reference', 'container', 'backburner'], function (exports, emberEnvironment, emberUtils, emberDebug, features, emberBabel, reference, container, Backburner) {
  ...
  */
  var ObserverSet = function () {
    ...
    ObserverSet.prototype.add = function add(object, key) {
    ...
    ObserverSet.prototype.forEach = function forEach(cb) {
      for (var i = 0; i < this.queue.length; i++) {
        var _queue$i = this.queue[i],
            object = _queue$i.object,
            key = _queue$i.key;
...
enifed('rsvp', ['exports', 'ember-babel', 'node-module'], function (exports, _emberBabel, _nodeModule) {
  ...
  exports.filter = exports.async = exports.map = exports.reject = exports.resolve = exports.off = exports.on = exports.configure = exports.denodeify = exports.defer = exports.rethrow = exports.hashSettled = exports.hash = exports.race = exports.allSettled = exports.all = exports.EventTarget = exports.Promise = exports.asap = undefined;

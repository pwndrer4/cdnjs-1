...
enifed("@glimmer/util", ["exports", "ember-babel"], function (exports, _emberBabel) {
    ...
    exports.unreachable = exports.expect = exports.unwrap = exports.EMPTY_ARRAY = exports.ListSlice = exports.ListNode = exports.LinkedList = exports.EMPTY_SLICE = exports.dict = exports.DictSet = exports.Stack = exports.initializeGuid = exports.ensureGuid = exports.fillNulls = exports.assign = exports.assert = undefined;
...
enifed('ember-metal', ['exports', 'ember-environment', 'ember-utils', 'ember-debug', 'ember/features', 'ember-babel', '@glimmer/reference', 'container', 'backburner'], function (exports, emberEnvironment, emberUtils, emberDebug, features, emberBabel, reference, container, Backburner) {
  ...
  */
  var ObserverSet = function () {
    ...
    ObserverSet.prototype.add = function (object, key) {
      ...
      if (!keys.has(key)) {
        this.queue.push({ object: object, key: key });
        keys.add(key);
      }
    };

    ObserverSet.prototype.forEach = function (cb) {
      var i, _queue$i, object, key;

      for (i = 0; i < this.queue.length; i++) {
        _queue$i = this.queue[i], object = _queue$i.object, key = _queue$i.key;
  ...
  */
  function endPropertyChanges() {
    deferred--;
    if (deferred <= 0) {
      observerSet.forEach(function (object, key) {
        return sendEvent(object, key, [object, key]);
      });
      observerSet.clear();
    }
  }

...
this.compiled=null
var n=t.block
this.symbolTable={hasEval:n.hasEval,symbols:n.symbols.concat([c])}}e.prototype.compile=function(){if(null!==this.compiled)return this.compiled
...
return{normalized:a,type:s}}var De={INPUT:{form:!0,autocorrect:!0,list:!0},SELECT:{form:!0},OPTION:{form:!0},TEXTAREA:{form:!0},LABEL:{form:!0},FIELDSET:{form:!0},LEGEND:{form:!0},OBJECT:{form:!0},BUTTON:{form:!0}}
function Fe(e,t,n){var r=e.tagName,i={element:e,name:t,namespace:n}
if(e.namespaceURI===de)return Be(r,t,i)
var o=Ie(e,t),s=o.type,a=o.normalized
return"attr"===s?Be(r,a,i):function(e,t,n){if(Le(e,t))return new Ve(t,n)
if(function(e,t){return("INPUT"===e||"TEXTAREA"===e)&&"value"===t}(e,t))return new We(t,n)
if(function(e,t){return"OPTION"===e&&"selected"===t}(e,t))return new Ye(t,n)
return new He(t,n)}(r,a,i)}function Be(e,t,n){return Le(e,t)?new qe(n):new Ue(n)}var ze=function(e){this.attribute=e},Ue=function(e){(0,t.inherits)(n,e)
...
this._transaction=null
e.commit()}
e.prototype.attributeFor=function(e,t){return Fe(e,t,arguments.length>3&&void 0!==arguments[3]?arguments[3]:null)};(0,t.createClass)(e,[{key:"transaction",get:function(){return this._transaction}}])
...
r.prototype.didCreateElement=function(e,n,r){var i,o=e.component,a=e.classRef,u=e.environment;(0,p.setViewElement)(o,n)
...
if(l&&l.length)(function(e,n,r,i){for(var o,s,a,u=[],l=n.length-1;-1!==l;){o=n[l]
a=(s=Ze.parse(o))[1]
if(-1===u.indexOf(a)){u.push(a)
Ze.install(e,r,s,i)}l--}-1===u.indexOf("id")&&i.setAttribute("id",t.PrimitiveReference.create(r.elementId),!0,null);-1===u.indexOf("style")&&nt.install(e,r,i)})(n,l,o,r)
else{o.elementId&&r.setAttribute("id",t.PrimitiveReference.create(o.elementId),!1,null)
nt.install(n,o,r)}if(a){i=new it(a,a._propertyKey)
r.setAttribute("class",i,!1,null)}c&&c.length&&c.forEach(function(e){r.setAttribute("class",t.PrimitiveReference.create(e),!1,null)})
h&&h.length&&h.forEach(function(e){rt(n,o,e,r)})
r.setAttribute("class",t.PrimitiveReference.create("ember-view"),!1,null)
"ariaRole"in o&&r.setAttribute("role",$e(o,"ariaRole"),!1,null)
o._transitionTo("hasElement")
u.isInteractive&&o.trigger("willInsertElement")}
...
function xn(e){return{object:"component:"+e}}function Pn(e,t){return{source:void 0!==e?"template:"+e:void 0,namespace:t}}function Nn(e){var t=m.FACTORY_FOR.get(e)
if(t)return t.normalizedName}var jn={if:function(e,t){var n=t.positional
...
o=n.capture()
return W.create((0,t.curry)(i,o))}},Ln={action:new Zt},Mn=function(){function e(){this.handles=[void 0]
this.objToHandle=new WeakMap
this.builtInHelpers=jn
this.builtInModifiers=Ln
...
e.prototype._lookupComponentDefinition=function(e,t){var n,r=e,i=(0,p.lookupComponent)(t.owner,r,Pn(t.moduleName,void 0)),o=i.layout,a=i.component,u=(0,s.guidFor)(t.owner)+"|"+Nn(a)+"|"+Nn(o),c=this.componentDefinitionCache.get(u)
if(void 0!==c)return c
if(o&&!a&&h.ENV._TEMPLATE_ONLY_GLIMMER_COMPONENTS){n=new function(e){this.state=e
this.manager=Nt}(o)
this.componentDefinitionCache.set(u,n)
return n}var f=(0,l._instrumentStart)("render.getComponentDefinition",xn,r),d=o||a?new function(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:dt,n=arguments[2],r=arguments[3],i=arguments[4],o=arguments[5]
this.name=e
this.manager=t
...
this.template=i
this.args=o
this.state={name:e,ComponentClass:n,handle:r,template:i,capabilities:ft,symbolTable:a}}(r,void 0,a||t.owner.factoryFor((0,m.privatize)(_)),null,o):null
f()
this.componentDefinitionCache.set(u,d)
return d}
return e}(),In={create:function(){return(new Mn).compiler}},Dn=k({id:"o98Iahwz",block:'{"symbols":["&default"],"statements":[[13,1]],"hasEval":false}',meta:{moduleName:"packages/ember-glimmer/lib/templates/component.hbs"}}),Fn=k({id:"cNysaqQS",block:'{"symbols":[],"statements":[[1,[20,"outlet"],false]],"hasEval":false}',meta:{moduleName:"packages/ember-glimmer/lib/templates/outlet.hbs"}}),Bn="-top-level",zn="main",Un=function(){function e(e,t,n,r){this._environment=e
this.renderer=t
this.owner=n
this.template=r
var i=this.ref=new cn({outlets:{main:void 0},render:{owner:n,into:void 0,outlet:zn,name:Bn,controller:void 0,template:r}})
this.state={ref:i,name:Bn,outlet:zn,template:r,controller:void 0}}e.extend=function(t){return function(e){(0,i.inherits)(n,e)
...
e.setupEngineRegistry=function(e){e.register("view:-outlet",Un)
e.register("template:-outlet",Fn)
...
e.register((0,m.privatize)(b),Dn)
e.register("service:-glimmer-environment",Ue)
e.register((0,m.privatize)(C),In)
...
e&&e.proto()
if(!s){s=!0
a.PrototypeMixin.applyPartial(a.prototype)}return this.prototype}
...
e.underscore=S
e.capitalize=O})
e("ember-runtime/lib/utils",["exports","ember-metal","ember-utils","ember-runtime/lib/mixins/array","ember-runtime/lib/system/object"],function(e,t,n,r,i){"use strict"
...
if("array"===n)return!0
var i=t.length
return"number"==typeof i&&i==i&&"object"===n}
e.typeOf=a
...
"function"===t?i.default.detect(e)&&(t="class"):"object"===t&&(e instanceof Error?t="error":e instanceof i.default?t="instance":e instanceof Date&&(t="date"))
return t}})

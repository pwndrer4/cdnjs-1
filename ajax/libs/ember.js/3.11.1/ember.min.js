...
e.renderSettled=function(){if(null===Yt){Yt=E.default.defer();(0,o.getCurrentRunLoop)()||o.backburner.schedule("actions",null,Wt)}return Yt.promise}
...
e.register((0,_.privatize)(C()),On)
e.injection((0,_.privatize)(k()),"environment","-environment:main")
e.injection("template","compiler",(0,_.privatize)(A()))
...
class wt extends a.CachedReference{constructor(e,t){super()
this.inner=e
this.isVisible=t
this.tag=(0,a.combine)([e.tag,t.tag])}compute(){let e=this.inner.value()
if(!1!==this.isVisible.value())return e
if(e){let t=e+" "+_t
return rt(e)?tt(t):t}return Et}}const Rt={install(e,t,r){r.setAttribute("style",(0,a.map)(gt(t,"isVisible"),this.mapStyleValue),!1,null)},mapStyleValue:e=>!1===e?Et:null},Ot={install(e,t,r,n){let[i,s,o]=r.split(":")
...
return t||(this.dasherizedPath=(0,y.dasherize)(e))}return e||0===e?String(e):null}}class At extends a.CachedReference{constructor(e,t=null,r=null){super()
this.inner=e
this.truthy=t
this.falsy=r
...
this[Ct]=e
this.value=t}update(e){this[Ct][q](e)}}const xt=(0,_.privatize)(I()),Pt=[];(0,u.debugFreeze)(Pt)
...
return!0===n?(0,y.dasherize)(r):n||0===n?String(n):""}function Ar(e){return e}function kr(e,t,r,n,i){let s,a
...
return(0,f.flaggedInstrument)("interaction.ember-action",t,()=>(0,o.join)(s,a,...n(e)))}}const Cr=e=>(e=>null==e||"function"!=typeof e.toString)(e)?"":String(e)
...
return t&&!t.internal&&"modifier"===t.type?t.factory:void 0}function _n(e){return{object:"component:"+e}}function En(e,t){return{source:void 0!==e?"template:"+e:void 0,namespace:t}}const wn={if:function(e,{positional:t}){return Dr.create(t.at(0),t.at(1),t.at(2))},action:function(e,t){let r,{named:n,positional:i}=t,s=i.capture(),[o,u,...c]=s.references,h=(u.propertyKey,n.has("target")?n.get("target"):o),d=function(e,t){let r,n
t.length>0&&(r=(e=>t.map(e=>e.value()).concat(e)))
e&&(n=(t=>{let r=e.value()
r&&t.length>0&&(t[0]=(0,l.get)(t[0],r))
return t}))
return r&&n?e=>n(r(e)):r||n||Ar}(n.has("value")&&n.get("value"),c);(r="function"==typeof u[W]?kr(u,u,u[W],d):(0,a.isConst)(h)&&(0,a.isConst)(u)?kr(o.value(),h.value(),u.value(),d):function(e,t,r,n,i){return(...i)=>kr(e,t.value(),r.value(),n)(...i)}(o.value(),h,u,d))[Y]=!0
...
0
let{layout:s,component:o}=(0,d.lookupComponent)(r,n,En(t,i)),a=void 0===o?s:o
...
c=e.internal?new Jt(t(r),o.class,s):new br(n,o,t(r),s||r.lookup((0,_.privatize)(M())))}}null===c&&(c=new jt(n,o||r.factoryFor((0,_.privatize)(N())),null,s))
u()
...
this.state={ref:i,name:Cn,outlet:Sn,template:n,controller:void 0}}static extend(e){return class extends xn{static create(t){return t?super.create((0,m.assign)({},e,t)):super.create(e)}}}static reopenClass(e){(0,m.assign)(this,e)}static create(e){let{_environment:t,renderer:n,template:i}=e,s=e[r.OWNER]
...
2===n&&2!==e.kind?i.splice(s,1):e.kind=n}}writableListeners(){if(this._flattenedVersion===o&&(this.source===this.proto||-1===this._inheritedEnd)){0
...
o=e&&e.context}}return new C(this.router,e,t,o)}createParamHandlerInfo(e,t,r,n){let i={},s=t.length,o=[]

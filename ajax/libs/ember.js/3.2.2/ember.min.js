...
this.isDestroyed=!1
this.isDestroying=!1}e.prototype.lookup=function(e,t){return a(this,this.registry.normalize(e),t)}
e.prototype.destroy=function(){p(this)
this.isDestroying=!0}
e.prototype.finalizeDestroy=function(){h(this)
this.isDestroyed=!0}
e.prototype.reset=function(e){if(!this.isDestroyed)if(void 0===e){p(this)
h(this)}else(function(e,t){var n=e.cache[t]
...
for(t=0;t<i.length;t++)(n=r[i[t]]).destroy&&n.destroy()}function h(e){e.cache=(0,n.dictionary)(null)
e.factoryManagerCache=(0,n.dictionary)(null)}var f=new WeakMap,d=function(){function e(e,t,n,r){this.container=e
this.owner=e.owner
this.class=t
this.fullName=n
...
f.set(this,this)}e.prototype.toString=function(){void 0===this.madeToString&&(this.madeToString=this.container.registry.makeToString(this.class,this.fullName))
...
e.prototype.isValidFullName=function(e){return m.test(e)}

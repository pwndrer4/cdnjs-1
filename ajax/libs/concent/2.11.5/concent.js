(function (global, factory) {
  ...
  */
  ...
  function changeRefState(state, _temp, targetRef) {
    ...
    triggerReactSetState(targetRef, callInfo, targetRenderKey, calledBy, state, stateFor, ignoreRender, reactCallback, false, // committedState means final committedState
    function (renderType, committedState, updateRef) {
      ...
      callMiddlewares(skipMiddleware, passToMiddleware, function () {
        ...
        var realShare = saveSharedState$1(module, passToMiddleware.sharedState, modStateCalled, force); // TODO: 查看其它模块的cu函数里读取了当前模块的state或computed作为输入产生了的新的计算结果

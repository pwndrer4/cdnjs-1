(function (global, factory) {
  ...
  var _computedValues = (_computedValues2 = {}, _computedValues2[MODULE_GLOBAL] = {}, _computedValues2[MODULE_DEFAULT] = {}, _computedValues2[MODULE_CC] = {}, _computedValues2);

  var _computedRawValues = (_computedRawValues2 = {}, _computedRawValues2[MODULE_GLOBAL] = {}, _computedRawValues2[MODULE_DEFAULT] = {}, _computedRawValues2[MODULE_CC] = {}, _computedRawValues2);
  ...
  */
  ...
  function changeRefState (state, _temp, targetRef) {
    ...
    function (renderType, committedState, updateRef) {
      ...
      callMiddlewares(skipMiddleware, passToMiddleware, function () {
        ...
        var realShare = saveSharedState$1(module, passToMiddleware.sharedState, true); // TODO: 查看其它模块的cu函数里读取了当前模块的state或computed作为输入产生了的新的计算结果
        ...
        if (realShare) triggerBroadcastState(stateFor, callInfo, targetRef, realShare, ignoreRender, module, reactCallback, targetRenderKey, targetDelay);
      });
    });
  }
  ...
  function triggerBroadcastState(stateFor, callInfo, targetRef, sharedState, allowOriInsRender, moduleName, reactCallback, renderKeys, delay$$1) {
    var passAllowOri = allowOriInsRender;

    if (delay$$1 > 0) {
      if (passAllowOri) {
        // 优先将当前实例渲染了
        triggerReactSetState(targetRef, callInfo, [], SET_STATE$1, sharedState, stateFor, false, reactCallback);
      }
  ...
  function broadcastState(callInfo, targetRef, partialSharedState, allowOriInsRender, moduleName, reactCallback, renderKeys) {
    ...
    belongRefKeys.forEach(function (refKey) {
      ...
      triggerReactSetState(ref, callInfo, [], calledBy, partialSharedState, FOR_CUR_MOD$1, false, rcb);
  ...
  function _debugComputed (moduleName) {
    var module2cuRaw = ccContext.computed._computedRaw;
    var cuKeys = okeys(module2cuRaw[moduleName]);
    var map = {};

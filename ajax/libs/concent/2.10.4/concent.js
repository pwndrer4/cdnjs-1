(function (global, factory) {
  ...
  */
  ...
  function initModuleLifecycle (moduleName, lifecycle) {
    ...
    var d = makeModuleDispatcher(moduleName); // loaded just means that moudle state、reducer、watch、computed configuration were recorded to ccContext
  ...
  function buildRefCtx (ref, params, liteLevel) {
    ...
    var refs = {}; // depDesc = {stateKey2retKeys: {}, retKey2fn:{}}
  ...
  var _getGlobalComputed = (function () {
    return _computedValue$4[MODULE_GLOBAL];
  });

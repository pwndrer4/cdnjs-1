...
function x(t) {
  ((!t.__d && (t.__d = !0) && u.push(t) && !C.__r++) ||
    p !== s.debounceRendering) &&
    ((p = s.debounceRendering) || l)(C);
}
function C() {
  for (var t; (C.__r = u.length); )
...
function N(t, e, n, r, o, i, s, a, u, l) {
  var p,
    ...
    k = P.length;
  for (
    u == f && (u = null != s ? s[0] : k ? S(r, 0) : null), n.__k = [], p = 0;
    p < e.length;
    p++
  )
    if (
      ...
      if (
        ((_.__ = n),
        (_.__b = n.__b + 1),
        null === (h = P[p]) || (h && _.key == h.key && _.type === h.type))
      )
        P[p] = void 0;
      else
        for (c = 0; c < k; c++) {
  ...
  if (((n.__e = m), null != s && 'function' != typeof n.type))
    for (p = s.length; p--; ) null != s[p] && y(s[p]);
  for (p = k; p--; ) null != P[p] && A(P[p], P[p]);
  if (b) for (p = 0; p < b.length; p++) j(b[p], b[++p], b[++p]);
}
  ...
  if ((o && 'className' == e && (e = 'class'), 'style' === e))
    if ('string' == typeof n) t.style.cssText = n;
      ...
      if (('string' == typeof r && (t.style.cssText = r = ''), r))
        for (e in r) (n && e in n) || F(t.style, e, '');
...
function I(t, e, n) {
  ...
  for (r = 0; r < t.__k.length; r++)
    (o = t.__k[r]) &&
      ((o.__ = t),
      o.__e &&
        ('function' == typeof o.type && o.__k.length > 1 && I(o, e, n),
        (e = T(n, o, o, t.__k, null, o.__e, e)),
...
function L(t, e, n, r, o, i, a, u, l) {
  ...
  try {
    t: if ('function' == typeof k) {
      if (
        ((m = e.props),
        (v = (p = k.contextType) && r[p.__c]),
        (b = p ? (v ? v.props.value : p.__) : r),
        n.__c
          ? (y = (c = e.__c = n.__c).__ = c.__E)
        ...
        null != k.getDerivedStateFromProps &&
          ...
          g(c.__s, k.getDerivedStateFromProps(m, c.__s))),
        (f = c.props),
        (d = c.state),
        h)
      )
      ...
      (c.context = b),
        ...
        (S = null != p && p.type == w && null == p.key ? p.props.children : p),
        N(t, Array.isArray(S) ? S : [S], e, n, r, o, i, a, u, l),
        (c.base = e.__e),
        (e.__h = null),
        c.__h.length && a.push(c),
        y && (c.__E = c.__ = null),
...
function U(t, e, n, r, o, i, s, a) {
  ...
  if (null === e.type) _ === g || (a && t.data === g) || (t.data = g);
  else {
    if (
      (null != i && (i = d.slice.call(t.childNodes)),
      (p = (_ = n.props || f).dangerouslySetInnerHTML),
    ...
    (function (t, e, n, r, o) {
      var i;
      for (i in n)
        'children' === i || 'key' === i || i in e || O(t, i, null, n[i], r);
      for (i in e)
      ...
      a ||
        ('value' in g &&
          ...
          O(t, 'value', u, _.value, !1),
        'checked' in g &&
          void 0 !== (u = g.checked) &&
          u !== t.checked &&
          O(t, 'checked', u, _.checked, !1));
  }
  return t;
}
function j(t, e, n) {
...
function A(t, e, n) {
  ...
  if (
    ...
    (r = t.ref) && ((r.current && r.current !== t.__e) || j(r, null, e)),
...
function $(t, e) {
  return m(K, { content: t, parentElement: e });
}
var V = (function (t) {
    function n(e) {
          ...
          m(
            ...
            this.pages > e &&
              ...
              m(
                ...
                m('button', { tabIndex: -1, className: et('spread') }, '...'),
              ),
    ...
    return (
      ...
      (r.prototype.adjustWidth = function (t, e, n, o) {
        ...
        for (
          ...
          (p.columns && p.columns.length > 0) ||
            (!p.width && o
              ? (p.width = mt(vt(s.current.base, p.id)))
              : (p.width = mt(yt(p.width, i))));
        }
      ...
      (r.prototype.populatePlugins = function (t, e) {
        for (var r = 0, o = e; r < o.length; r++) {
          ...
          void 0 !== i.plugin &&
            t.plugin.add(
              n(n({ id: i.id, props: {} }, i.plugin), { position: rt.Cell }),
            );
        }
      }),
  ...
  Tt = (function () {
    ...
    return (
      (t.createFromUserConfig = function (t) {
        var e = null;
        return (
          t.data && (e = new Ct(t.data)),
          t.from &&
            ((e = new Ct(this.tableElementToArray(t.from))),
          ...
          return o(this, function (o) {
            switch (o.label) {
              ...
              case 6:
                return [3, 8];
              case 7:
                throw ((u = o.sent()), lt.error(u), this.emit('error', r), u);
              case 8:
                return (
    ...
    return (
      (t.createFromConfig = function (t) {
        ...
        return (
          ...
          e.register(new It({ header: t.header })),
          e.register(new Dt()),
          e
        );
      }),
    ...
    return (
      ...
      (t.fromUserConfig = function (e) {
        ...
        return (
          ...
          r.assign({ header: St.fromUserConfig(r) }),
          r.assign({ storage: Tt.createFromUserConfig(e) }),
          r.assign({ pipeline: Lt.createFromConfig(r) }),
          r.assign({ translator: new G(e.language) }),
          r.plugin.add({
            id: 'search',
            position: rt.Header,
            component: ft,
...
var Ut = (function (t) {
        ...
        return this.props.children
          ...
          : m(
              ...
              this.props.row.cells.map(function (e, n) {
                ...
                return r && r.hidden
                  ? null
                  : m(Ut, { key: e.id, cell: e, row: t.props.row, column: r });
              }),
            );
      }),
      (n.prototype.render = function () {
        return m(
          'tr',
          { className: et('tr'), onClick: this.handleClick.bind(this) },
          this.getChildren(),
        );
      }),
      n
        ...
        return m(
          ...
          this.props.data &&
            this.props.data.rows.map(function (e) {
              return m(jt, { key: e.id, row: e, header: t.props.header });
            }),
  ...
  Gt = (function (t) {
    function r(e, n) {
      var r = t.call(this, e, n) || this;
      return (
        (r.actions = new Bt(r.config.dispatcher)),
        (r.store = new Wt(r.config.dispatcher)),
        e.enabled &&
...
var Kt,
    ...
    return (
      ...
      (n.prototype.renderColumn = function (t, e, n, r) {
        var o = (function (t, e, n) {
          ...
          i = o.rowSpan,
          s = o.colSpan;
        return m(zt, { column: t, index: n, colSpan: s, rowSpan: i });
      }),
      ...
      (n.prototype.render = function () {
        return this.props.header
          ? m(
              'thead',
              { key: this.props.header.id, className: et('thead') },
              this.renderRows(),
            )
          : null;
      }),
        ...
        return m(
          ...
          m(
            ...
            this.state.status === Pt.Loading &&
              m('div', { className: et('loading-bar') }),
            m(Zt, null),
            m(
              'div',
              {
  ...
  ae = s.unmount;
function ue(t, e) {
  s.__h && s.__h($t, t, ee || e), (ee = 0);
  var n = $t.__H || ($t.__H = { __: [], __h: [] });
  return t >= n.__.length && n.__.push({}), n.__[t];
}
function le(t, e) {
  var n = ue(Kt++, 3);
  !s.__s && _e(n.__H, e) && ((n.__ = t), (n.__H = e), $t.__H.__h.push(n));
}
function pe(t) {
  return (
    (ee = 5),
...
function ce() {
  ne.forEach(function (t) {
    if (t.__P)
      try {
        t.__H.__h.forEach(fe), t.__H.__h.forEach(de), (t.__H.__h = []);
      } catch (e) {
...
(s.__b = function (t) {
  ...
  (s.__r = function (t) {
    oe && oe(t), (Kt = 0);
    var e = ($t = t.__c).__H;
    e && (e.__h.forEach(fe), e.__h.forEach(de), (e.__h = []));
  }),
  (s.diffed = function (t) {
    ie && ie(t);
    var e = t.__c;
    e &&
      e.__H &&
      e.__H.__h.length &&
      ((1 !== ne.push(e) && Vt === s.requestAnimationFrame) ||
        (
          (Vt = s.requestAnimationFrame) ||
          function (t) {
            var e,
              n = function () {
...
function fe(t) {
  var e = $t;
  'function' == typeof t.__c && t.__c(), ($t = e);
}
function de(t) {
  var e = $t;
  (t.__c = t.__()), ($t = e);
...
export {
  ...
  kt as Dispatcher,
  te as Grid,
  pt as PluginBaseComponent,
  rt as PluginPosition,
  Y as Row,
  et as className,
  m as createElement,
  b as createRef,

!(function (t, e) {
  ...
  function C(t) {
    ((!t.__d && (t.__d = !0) && l.push(t) && !N.__r++) ||
      c !== a.debounceRendering) &&
      ((c = a.debounceRendering) || p)(N);
  }
  function N() {
    for (var t; (N.__r = l.length); )
  ...
  function T(t, e, n, r, o, i, s, a, u, l) {
    var p,
      ...
      S = w.length;
    for (
      u == d && (u = null != s ? s[0] : S ? x(r, 0) : null), n.__k = [], p = 0;
      p < e.length;
      p++
    )
      if (
        null !=
        (f = n.__k[p] =
          null == (f = e[p]) || 'boolean' == typeof f
            ? null
            : 'string' == typeof f || 'number' == typeof f
            ? b(null, f, null, null, f)
            : Array.isArray(f)
            ? b(P, { children: f }, null, null, null)
        ...
        if (
          ((f.__ = n),
          (f.__b = n.__b + 1),
          null === (h = w[p]) || (h && f.key == h.key && f.type === h.type))
        )
          w[p] = void 0;
        else
          for (c = 0; c < S; c++) {
          ...
          null != g
            ? (null == y && (y = g),
              ...
              l || 'option' != n.type
                ...
                : (t.value = ''))
            : u && h.__e == u && u.parentNode != t && (u = x(h));
      }
  ...
  function O(t, e, n, r, o, i, s) {
    ...
    if (void 0 !== e.__d) (a = e.__d), (e.__d = void 0);
      ...
      t: if (null == s || s.parentNode !== t) t.appendChild(i), (a = null);
      else {
        for (u = s, l = 0; (u = u.nextSibling) && l < r.length; l += 2)
          if (u == i) break t;
    ...
    if ((o && 'className' == e && (e = 'class'), 'style' === e))
      ...
      'o' === e[0] && 'n' === e[1]
        ? ((i = e !== (e = e.replace(/Capture$/, ''))),
          ...
          (t.l[e + i] = n),
          (a = i ? I : E),
          n ? r || t.addEventListener(e, a, i) : t.removeEventListener(e, a, i))
        : 'list' !== e &&
          'tagName' !== e &&
          'form' !== e &&
          'type' !== e &&
  ...
  function L(t, e, n) {
    ...
    for (r = 0; r < t.__k.length; r++)
      (o = t.__k[r]) &&
        ((o.__ = t),
        o.__e &&
          ('function' == typeof o.type && o.__k.length > 1 && L(o, e, n),
          (e = O(n, o, o, t.__k, null, o.__e, e)),
      ...
      t: if ('function' == typeof x) {
        if (
          ...
          null != x.getDerivedStateFromProps &&
            (c.__s == c.state && (c.__s = y({}, c.__s)),
            y(c.__s, x.getDerivedStateFromProps(m, c.__s))),
          (f = c.props),
          (d = c.state),
          h)
        )
          ...
          if (
            (null == x.getDerivedStateFromProps &&
              ...
              c.componentWillReceiveProps(m, b),
            (!c.__e &&
              null != c.shouldComponentUpdate &&
              !1 === c.shouldComponentUpdate(m, c.__s, b)) ||
              e.__v === n.__v)
          ) {
            (c.props = m),
              (c.state = c.__s),
          ...
          null != c.componentWillUpdate && c.componentWillUpdate(m, c.__s, b),
        ...
        (c.context = b),
          ...
          (c.state = c.__s),
          null != c.getChildContext && (r = y(y({}, r), c.getChildContext())),
          h ||
            null == c.getSnapshotBeforeUpdate ||
            (_ = c.getSnapshotBeforeUpdate(f, d)),
          (w =
            null != p && p.type == P && null == p.key ? p.props.children : p),
          T(t, Array.isArray(w) ? w : [w], e, n, r, o, i, s, u, l),
          (c.base = e.__e),
          (e.__h = null),
          c.__h.length && s.push(c),
          g && (c.__E = c.__ = null),
  ...
  function U(t, e, n, r, o, i, s, a) {
    ...
    if (((o = 'svg' === e.type || o), null != i))
      for (u = 0; u < i.length; u++)
        if (
          null != (l = i[u]) &&
          ((null === e.type ? 3 === l.nodeType : l.localName === e.type) ||
            t == l)
        ) {
          (t = l), (i[u] = null);
          break;
    ...
    if (null === e.type) f === g || (a && t.data === g) || (t.data = g);
      ...
      if (
        (null != i && (i = _.slice.call(t.childNodes)),
        (p = (f = n.props || d).dangerouslySetInnerHTML),
        ...
        (c || p) &&
          ((c && ((p && c.__html == p.__html) || c.__html === t.innerHTML)) ||
      ...
      (function (t, e, n, r, o) {
        ...
        a ||
          ('value' in g &&
            void 0 !== (u = g.value) &&
            (u !== t.value || ('progress' === e.type && !u)) &&
            F(t, 'value', u, f.value, !1),
          'checked' in g &&
            void 0 !== (u = g.checked) &&
            u !== t.checked &&
            F(t, 'checked', u, f.checked, !1));
    }
    return t;
  }
  function A(t, e, n) {
  ...
  function H(t, e, n) {
    ...
    if ((r = t.__k)) for (i = 0; i < r.length; i++) r[i] && H(r[i], e, n);
    null != o && m(o);
  }
  function M(t, e, n) {
  ...
  (a = {
    ...
    (S.prototype.setState = function (t, e) {
      ...
      (n =
        ...
        'function' == typeof t && (t = t(y({}, n), this.props)),
        t && y(n, t),
  ...
  function V(t, e) {
    return v($, { content: t, parentElement: e });
  }
  var Y = (function (t) {
      function e(e) {
  ...
  ((ot = t.PluginPosition || (t.PluginPosition = {}))[(ot.Header = 0)] =
    'Header'),
    (ot[(ot.Footer = 1)] = 'Footer'),
    (ot[(ot.Cell = 2)] = 'Cell');
  var ht = (function () {
      function t() {
        this.plugins = [];
      ...
      return (
        ...
        (t.prototype.add = function (t) {
          return t.id
            ? null !== this.get(t.id)
              ? (pt.error('Duplicate plugin ID: ' + t.id), this)
              : (this.plugins.push(t), this)
            : (pt.error('Plugin ID cannot be empty'), this);
        }),
      ...
      function e(e, n) {
        ...
        if (o) {
          ...
          (s = e.server
            ...
            : new et({ keyword: e.keyword, selector: e.selector })),
            (r.searchProcessor = s),
            ...
            v(
              ...
              this.pages > e &&
                ...
                v(
                  ...
                  v('button', { tabIndex: -1, className: nt('spread') }, '...'),
                ),
      ...
      return (
        ...
        (o.prototype.adjustWidth = function (t, e, n, r) {
          ...
          for (
            ...
            (p.columns && p.columns.length > 0) ||
              (!p.width && r
                ? (p.width = vt(bt(s.current.base, p.id)))
                : (p.width = vt(mt(p.width, i))));
          }
        ...
        (o.prototype.setID = function (t) {
          for (var e = 0, n = t || this.columns || []; e < n.length; e++) {
            var r = n[e];
            r.id || 'string' != typeof r.name || (r.id = Pt(r.name)),
              r.id ||
                pt.error(
      ...
      return (
        (t.createFromUserConfig = function (t) {
          ...
          return (
            ...
            t.server && (e = new Tt(t.server)),
            e || pt.error('Could not determine the storage type', !0),
            e
          );
        }),
    ...
    Rt = (function () {
      ...
      return (
        (t.createFromConfig = function (t) {
          var e = new Dt();
          return (
            t.storage instanceof Tt &&
              e.register(new It({ serverStorageOptions: t.server })),
            e.register(new Ft({ storage: t.storage })),
            e.register(new Lt({ header: t.header })),
            e.register(new Et()),
            e
          );
        }),
      ...
      return (
        ...
        (e.fromUserConfig = function (n) {
          ...
          return (
            ...
            o.assign({ header: xt.fromUserConfig(o) }),
            o.assign({ storage: Ot.createFromUserConfig(n) }),
            o.assign({ pipeline: Rt.createFromConfig(o) }),
            o.assign({ translator: new z(n.language) }),
            o.plugin.add({
              id: 'search',
  ...
  var Ut = (function (t) {
    ...
    At = (function (t) {
      ...
      return (
        ...
        (e.prototype.render = function () {
          return v(
            'tr',
            { className: nt('tr'), onClick: this.handleClick.bind(this) },
            this.getChildren(),
          );
        }),
        e
          ...
          return v(
            ...
            this.props.data &&
              this.props.data.rows.map(function (e) {
                return v(At, { key: e.id, row: e, header: t.props.header });
              }),
            this.props.status === St.Loading &&
        ...
        (e.prototype.validateProps = function () {
          for (var t = 0, e = this.props.columns; t < e.length; t++) {
            ...
            void 0 === n.direction && (n.direction = 1),
              1 !== n.direction &&
                -1 !== n.direction &&
                pt.error('Invalid sort direction ' + n.direction);
          }
        }),
        Object.defineProperty(e.prototype, 'type', {
          get: function () {
    ...
    zt = (function (t) {
      function e(e, n) {
        var r = t.call(this, e, n) || this;
        return (
          (r.actions = new qt(r.config.dispatcher)),
              ...
              : ((this.updateSortProcessorFn = this.updateSortProcessor.bind(
                ...
                (e =
                  t === J.ServerSort
                    ...
                    : new Wt({ columns: this.store.state })),
                this.config.pipeline.register(e)),
            e
          );
        }),
      ...
      return (
        ...
        (e.prototype.renderColumn = function (t, e, n, r) {
          var o = (function (t, e, n) {
            ...
            i = o.rowSpan,
            s = o.colSpan;
          return v(Kt, { column: t, index: n, colSpan: s, rowSpan: i });
        }),
        (e.prototype.renderRow = function (t, e, n) {
          var r = this,
            o = xt.leafColumns(this.props.header.columns);
          return v(
            At,
            null,
            t.map(function (t) {
        ...
        (e.prototype.render = function () {
          return this.props.header
            ? v(
                'thead',
                { key: this.props.header.id, className: nt('thead') },
                this.renderRows(),
              )
            : null;
        }),
        ...
        (o.prototype.render = function () {
          return this.state.isActive
            ? v(
                ...
                v(ft, { position: t.PluginPosition.Header }),
              )
            : null;
        }),
        o
        ...
        (o.prototype.render = function () {
          return this.state.isActive
            ? v(
                ...
                v(ft, { position: t.PluginPosition.Footer }),
              )
            : null;
        }),
        o
    ...
    te = (function (t) {
      function e(e, n) {
        ...
        return (
          ...
          (r.state = { status: St.Loading, header: e.header, data: null }),
          r
        );
      }
      return (
            ...
            return i(this, function (n) {
              switch (n.label) {
                ...
                case 2:
                  return (
                    (t = n.sent()),
                    this.setState({ data: t, status: St.Loaded }),
                ...
                case 3:
                  return (
                    (e = n.sent()),
                    pt.error(e),
                    this.setState({ status: St.Error, data: null }),
                    [3, 4]
                  );
                case 4:
                  return [2];
        ...
        (e.prototype.componentDidUpdate = function (t, e) {
          e.status != St.Rendered &&
            this.state.status == St.Loaded &&
            (this.setState({ status: St.Rendered }),
            ...
            v(
              'div',
              {
                ...
                className: rt(
                  'gridjs',
                  nt('container'),
                  this.state.status === St.Loading ? nt('loading') : null,
              ...
              this.state.status === St.Loading &&
                v('div', { className: nt('loading-bar') }),
              v(Jt, null),
              v(
                'div',
                {
    ...
    ee = (function (t) {
      ...
      return (
        ...
        (e.prototype.render = function (t) {
          return (
            t || pt.error('Container element cannot be null', !0),
  ...
  (a.__b = function (t) {
    ...
    (a.diffed = function (t) {
      ...
      e &&
        e.__H &&
        e.__H.__h.length &&
        ((1 !== re.push(e) && Yt === a.requestAnimationFrame) ||
          (
            (Yt = a.requestAnimationFrame) ||
            function (t) {
              var e,
                n = function () {
  ...
  function he(t) {
    var e = Vt;
    'function' == typeof t.__c && t.__c(), (Vt = e);
  }
  function fe(t) {
    var e = Vt;
    (t.__c = t.__()), (Vt = e);
  ...
  (t.BaseActions = at),
    ...
    (t.useEffect = function (t, e) {
      var n = le($t++, 3);
      !a.__s && de(n.__H, e) && ((n.__ = t), (n.__H = e), Vt.__H.__h.push(n));
    }),
    (t.useRef = function (t) {
      return (
        (ne = 5),

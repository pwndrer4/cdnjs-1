...
var TD = /** @class */ (function (_super) {
    ...
    TD.prototype.render = function () {
        return (v("td", { role: this.props.role, colSpan: this.props.colSpan, "data-column-id": this.props.column && this.props.column.id, className: classJoin(className('td'), this.props.className, this.config.className.td), style: __assign({}, this.config.style.td), onClick: this.handleClick.bind(this) }, this.content()));
    };
    return TD;
}(BaseComponent));

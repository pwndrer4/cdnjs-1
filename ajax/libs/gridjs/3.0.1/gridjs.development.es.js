...
var PluginRenderer = /** @class */ (function (_super) {
    ...
    PluginRenderer.prototype.render = function () {
        ...
        if (this.props.pluginId) {
            ...
            if (!plugin)
                return null;
            return h(p, {}, h(plugin.component, __assign(__assign({ plugin: plugin }, plugin.props), this.props.props)));
        }
        else if (this.props.position !== undefined) {
            // render using a specific plugin position
            return h(p, {}, this.config.plugin
                .list(this.props.position)
                .map(function (p) {
                return h(p.component, __assign(__assign({ plugin: p }, p.props), _this.props.props));
            }));
        }
        return null;
    };
...
var ShadowTable = /** @class */ (function (_super) {
    ...
    ShadowTable.prototype.render = function () {
        if (this.props.tableRef.current) {
            ...
            return (h("div", { ref: function (nodeElement) {
...
var TD = /** @class */ (function (_super) {
    ...
    TD.prototype.content = function () {
        ...
        if (this.props.column && this.props.column.plugin) {
            return (h(PluginRenderer, { pluginId: this.props.column.id, props: {
    ...
    TD.prototype.render = function () {
        return (h("td", __assign({ role: this.props.role, colSpan: this.props.colSpan, "data-column-id": this.props.column && this.props.column.id, className: classJoin(className('td'), this.props.className, this.config.className.td), style: __assign(__assign({}, this.props.style), this.config.style.td), onClick: this.handleClick.bind(this) }, this.getCustomAttributes(this.props.column)), this.content()));
    };
    return TD;
}(BaseComponent));
...
var TR = /** @class */ (function (_super) {
    ...
    TR.prototype.getChildren = function () {
        ...
        if (this.props.children) {
            ...
            return (h(p, null, this.props.row.cells.map(function (cell, i) {
                var column = _this.getColumn(i);
                if (column && column.hidden)
                    return null;
                return (h(TD, { key: cell.id, cell: cell, row: _this.props.row, column: column }));
            })));
        }
    };
    TR.prototype.render = function () {
        return (h("tr", { className: className('tr'), onClick: this.handleClick.bind(this) }, this.getChildren()));
    };
    return TR;
}(BaseComponent));
...
var TH = /** @class */ (function (_super) {
    ...
    TH.prototype.content = function () {
        ...
        if (this.props.column.plugin !== undefined) {
            return (h(PluginRenderer, { pluginId: this.props.column.plugin.id, props: {
                    column: this.props.column,
                } }));
        }
        return null;
        ...
        return (h(configContext.Provider, { value: this.props.config },
            h("div", { role: "complementary", className: classJoin('gridjs', className('container'), this.state.status === Status.Loading ? className('loading') : null, this.props.config.className.container), style: __assign(__assign({}, this.props.config.style.container), {
                ...
                h("div", { className: className('wrapper'), style: { width: this.props.width, height: this.props.height } },
                    h(Table, { ref: this.props.config.tableRef, data: this.state.data, header: this.state.header, width: this.props.width, height: this.props.height, status: this.state.status })),
...
export { BaseActions, BaseComponent, BaseStore, Cell, d as Component, Config, Dispatcher, Grid, PluginBaseComponent, PluginPosition, Row, className, h as createElement, y as createRef, h, html, y$1 as useEffect, h$1 as useRef };

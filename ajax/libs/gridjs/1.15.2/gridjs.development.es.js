...
var TH = /** @class */ (function (_super) {
    ...
    TH.prototype.render = function () {
        ...
        return (v("th", __assign({ className: classJoin(className('th'), this.isSortable() ? className('th', 'sort') : null, this.props.column.fixedHeader ? className('th', 'fixed') : null, this.config.className.th), onClick: this.onClick.bind(this), style: __assign(__assign({}, this.config.style.th), { width: this.props.column.width }), onKeyDown: this.keyDown.bind(this) }, props),
...
export { BaseComponent, d as Component, Config, Grid, PluginPosition, v as createElement, y as createRef, v as h, html, p$1 as useEffect, h$1 as useRef };

...
function html(content, parentElement) {
    return h(HTMLElement$1, { content: content, parentElement: parentElement });
}
...
var Search = /** @class */ (function (_super) {
    ...
    Search.prototype.render = function () {
        ...
        return (h("div", { className: className('search') },
            h("input", { type: "search", placeholder: this._('search.placeholder'), "aria-label": this._('search.placeholder'), onInput: onInput, className: classJoin(className('input'), className('search', 'input')), value: this.store.state.keyword })));
    };
    Search.defaultProps = {
        debounceTimeout: 250,
    };
...
var Pagination = /** @class */ (function (_super) {
    ...
    Pagination.prototype.renderPages = function () {
        ...
        return (h(p, null,
            this.pages > maxCount && this.state.page - pagePivot > 0 && (h(p, null,
                h("button", { tabIndex: 0, onClick: this.setPage.bind(this, 0), title: this._('pagination.firstPage') }, this._('1')),
                h("button", { tabIndex: -1, className: className('spread') }, "..."))),
            Array.from(Array(maxCount).keys())
                .map(function (i) { return _this.state.page + (i - pagePivot); })
                .map(function (i) { return (h("button", { tabIndex: 0, onClick: _this.setPage.bind(_this, i), className: _this.state.page === i ? className('currentPage') : null, title: _this._('pagination.page', i + 1) }, _this._("" + (i + 1)))); }),
            this.pages > maxCount && this.pages > this.state.page + pagePivot + 1 && (h(p, null,
                h("button", { tabIndex: -1, className: className('spread') }, "..."),
                h("button", { tabIndex: 0, onClick: this.setPage.bind(this, this.pages - 1), title: this._('pagination.page', this.pages) }, this._("" + this.pages))))));
    };
    Pagination.prototype.renderSummary = function () {
        return (h(p, null, this.props.summary && this.state.total > 0 && (h("div", { role: "status", className: className('summary'), title: this._('pagination.navigate', this.state.page + 1, this.pages) },
            this._('pagination.showing'),
            ' ',
            h("b", null, this._("" + (this.state.page * this.state.limit + 1))),
            ' ',
            this._('pagination.to'),
            ' ',
            h("b", null, this._("" + Math.min((this.state.page + 1) * this.state.limit, this.state.total))),
            ' ',
            this._('pagination.of'),
            " ",
            h("b", null, this._("" + this.state.total)),
            ' ',
    ...
    Pagination.prototype.render = function () {
        ...
        return (h("div", { className: className('pagination') },
            ...
            h("div", { className: className('pages') },
                this.props.prevButton && (h("button", { tabIndex: 0, disabled: this.state.page === 0, onClick: this.setPage.bind(this, this.state.page - 1) }, this._('pagination.previous'))),
                this.renderPages(),
                this.props.nextButton && (h("button", { tabIndex: 0, disabled: this.pages === this.state.page + 1 || this.pages === 0, onClick: this.setPage.bind(this, this.state.page + 1) }, this._('pagination.next'))))));
    };
...
var ShadowTable = /** @class */ (function (_super) {
    ...
    ShadowTable.prototype.head = function () {
        ...
        return (h("thead", { style: this.resetStyle() }, rows.map(function (row, rowIndex) {
            return (h("tr", null, row.map(function (col) {
                var _a = calculateRowColSpans(col, rowIndex, totalRows), rowSpan = _a.rowSpan, colSpan = _a.colSpan;
                return (h("th", { "data-column-id": col && col.id, style: __assign(__assign({}, _this.resetStyle()), { whiteSpace: 'nowrap', 
                        // pagination buttons
                        paddingRight: col.sort && col.sort.enabled ? '18px' : '0' }), colSpan: colSpan > 1 ? colSpan : undefined, rowSpan: rowSpan > 1 ? rowSpan : undefined }, col.name));
            })));
        })));
    };
    ...
    StorageResponseToArrayTransformer.prototype.castData = function (data) {
        ...
        if (typeof data[0] === 'object' && !(data[0] instanceof Array)) {
            return data.map(function (row) {
                return _this.props.header.columns.map(function (column, i) {
...
var PluginRenderer = /** @class */ (function (_super) {
    ...
    PluginRenderer.prototype.render = function () {
        return h(p, {}, this.config.plugin.list(this.props.position).map(function (p) { return p.component; }));
    };
...
var Config = /** @class */ (function () {
    ...
    Config.fromUserConfig = function (userConfig) {
        ...
        config.plugin.add({
            ...
            component: h(Search, __assign({ enabled: userConfig.search === true || userConfig.search instanceof Object }, userConfig.search)),
        });
        // Pagination
        config.plugin.add({
            id: 'pagination',
            position: PluginPosition.Footer,
            component: h(Pagination, __assign({ enabled: userConfig.pagination === true ||
...
var TD = /** @class */ (function (_super) {
    ...
    TD.prototype.render = function () {
        return (h("td", __assign({ role: this.props.role, colSpan: this.props.colSpan, "data-column-id": this.props.column && this.props.column.id, className: classJoin(className('td'), this.props.className, this.config.className.td), style: __assign({}, this.config.style.td), onClick: this.handleClick.bind(this) }, this.getCustomAttributes(this.props.column)), this.content()));
    };
    return TD;
}(BaseComponent));
...
var TR = /** @class */ (function (_super) {
    ...
    TR.prototype.render = function () {
        ...
        if (this.props.children) {
            ...
            return (h("tr", { className: className('tr'), onClick: this.handleClick.bind(this) }, this.props.row.cells.map(function (cell, i) {
...
var MessageRow = /** @class */ (function (_super) {
    ...
    MessageRow.prototype.render = function () {
        return (h(TR, null,
            h(TD, { role: "alert", colSpan: this.props.colSpan, cell: new Cell(this.props.message), className: classJoin(className('message'), this.props.className ? this.props.className : null) })));
    };
    return MessageRow;
}(BaseComponent));
    ...
    TBody.prototype.render = function () {
        ...
        return (h("tbody", { className: className('tbody') },
            ...
            this.props.status === Status.Loading &&
                (!this.props.data || this.props.data.length === 0) && (h(MessageRow, { message: this._('loading'), colSpan: this.headerLength(), className: className('loading') })),
            this.props.status === Status.Rendered &&
                this.props.data &&
                this.props.data.length === 0 && (h(MessageRow, { message: this._('noRecordsFound'), colSpan: this.headerLength(), className: className('notfound') })),
            this.props.status === Status.Error && (h(MessageRow, { message: this._('error'), colSpan: this.headerLength(), className: className('error') }))));
    };
    return TBody;
}(BaseComponent));
...
var TH = /** @class */ (function (_super) {
    ...
    TH.prototype.render = function () {
        ...
        return (h("th", __assign({ ref: this.thRef, "data-column-id": this.props.column && this.props.column.id, className: classJoin(className('th'), this.isSortable() ? className('th', 'sort') : null, this.props.column.fixedHeader ? className('th', 'fixed') : null, this.config.className.th), onClick: this.onClick.bind(this), style: __assign(__assign(__assign({}, this.config.style.th), { width: this.props.column.width }), this.state.style), onKeyDown: this.keyDown.bind(this), rowSpan: this.props.rowSpan > 1 ? this.props.rowSpan : undefined, colSpan: this.props.colSpan > 1 ? this.props.colSpan : undefined }, props),
            this.props.column.name,
            this.isSortable() && (h(Sort, __assign({ ref: this.sortRef, index: this.props.index }, this.props.column.sort)))));
    };
    return TH;
}(BaseComponent));
...
var THead = /** @class */ (function (_super) {
    ...
    THead.prototype.renderColumn = function (column, rowIndex, columnIndex, totalRows) {
        ...
        return (h(TH, { column: column, index: columnIndex, colSpan: colSpan, rowSpan: rowSpan }));
    };
    ...
    THead.prototype.render = function () {
        if (this.props.header) {
            return (h("thead", { key: this.props.header.id, className: className('thead') }, this.renderRows()));
        }
        return null;
    };
    return THead;
...
var HeaderContainer = /** @class */ (function (_super) {
    ...
    HeaderContainer.prototype.render = function () {
        if (this.state.isActive) {
            return (h("div", { ref: this.headerRef, className: classJoin(className('head'), this.config.className.header), style: __assign({}, this.config.style.header) },
...
var FooterContainer = /** @class */ (function (_super) {
    ...
    FooterContainer.prototype.render = function () {
        if (this.state.isActive) {
            return (h("div", { ref: this.footerRef, className: classJoin(className('footer'), this.config.className.footer), style: __assign({}, this.config.style.footer) },
...
var Container = /** @class */ (function (_super) {
    ...
    Container.prototype.render = function () {
        ...
        return (h(configContext.Provider, { value: this.props.config },
            h("div", { role: "complementary", className: classJoin('gridjs', className('container'), this.state.status === Status.Loading ? className('loading') : null, this.props.config.className.container), style: __assign(__assign({}, this.props.config.style.container), {
                    width: this.props.width,
                }) },
                this.state.status === Status.Loading && (h("div", { className: className('loading-bar') })),
                h(HeaderContainer, null),
                h("div", { className: className('wrapper'), style: { width: this.props.width, height: this.props.height } },
                    h(Table, { data: this.state.data, header: this.state.header, width: this.props.width, height: this.props.height, status: this.state.status })),
                h(FooterContainer, null)),
            h("div", { ref: this.props.config.tempRef, id: "gridjs-temp", className: className('temp') })));
    };
    return Container;
}(BaseComponent));
...
export { BaseComponent, d as Component, Config, Grid, PluginPosition, h as createElement, y as createRef, h, html, y$1 as useEffect, h$1 as useRef };

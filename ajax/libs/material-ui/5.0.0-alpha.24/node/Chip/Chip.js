...
const Chip = /*#__PURE__*/React.forwardRef(function Chip(props, ref) {
  const {
    ...
    variant = 'filled'
        ...
        other = (0, _objectWithoutPropertiesLoose2.default)(props, ["avatar", "classes", "className", "clickable", "color", "component", "deleteIcon", "disabled", "icon", "label", "onClick", "onDelete", "onKeyDown", "onKeyUp", "size", "variant"]);
  ...
  const Component = ComponentProp || (clickable || onDelete ? _ButtonBase.default : 'div');
  ...
  if (avatarProp && /*#__PURE__*/React.isValidElement(avatarProp)) {
    avatar = /*#__PURE__*/React.cloneElement(avatarProp, {
      className: (0, _clsx.default)(classes.avatar, avatarProp.props.className, small && classes.avatarSmall, color !== 'default' && classes[`avatarColor${(0, _capitalize.default)(color)}`])
    });
  }
  ...
  if (iconProp && /*#__PURE__*/React.isValidElement(iconProp)) {
    icon = /*#__PURE__*/React.cloneElement(iconProp, {
      className: (0, _clsx.default)(classes.icon, iconProp.props.className, small && classes.iconSmall, color !== 'default' && classes[`iconColor${(0, _capitalize.default)(color)}`])
    });
  }
  ...
  return /*#__PURE__*/React.createElement(Component, (0, _extends2.default)({
    className: (0, _clsx.default)(classes.root, classes[variant], themeVariantsClasses, className, color !== 'default' && [classes[`color${(0, _capitalize.default)(color)}`], clickable && classes[`clickableColor${(0, _capitalize.default)(color)}`], onDelete && classes[`deletableColor${(0, _capitalize.default)(color)}`]], disabled && classes.disabled, small && classes.sizeSmall, clickable && classes.clickable, onDelete && classes.deletable, variant === 'outlined' && {

...
var overridesResolver = function overridesResolver(props, styles) {
  ...
  return deepmerge(styles.root || {}, _extends({}, styleProps.formControl && styles.formControl, styleProps.startAdornment && styles.adornedStart, styleProps.endAdornment && styles.adornedEnd, styleProps.error && styles.error, styleProps.size === 'small' && styles.sizeSmall, styleProps.multiline && styles.multiline, styleProps.color && styles["color".concat(capitalize(styleProps.color))], styleProps.fullWidth && styles.fullWidth, styleProps.hiddenLabel && styles.hiddenLabel, _defineProperty({}, "& .".concat(inputBaseClasses.input), _extends({}, styles.input, styleProps.size === 'small' && styles.inputSizeSmall, styleProps.multiline && styles.inputMultiline, styleProps.type === 'search' && styles.inputTypeSearch, styleProps.startAdornment && styles.inputAdornedStart, styleProps.endAdornment && styles.inputAdornedEnd, styleProps.hiddenLabel && styles.inputHiddenLabel))));
};
...
var InputBaseRoot = experimentalStyled('div', {}, {
  name: 'MuiInputBase',
  slot: 'Root',
...
var InputBaseComponent = experimentalStyled('input', {
  ...
  }), _defineProperty(_extends3, '&.Mui-disabled', {
    opacity: 1,
    // Reset iOS opacity
    WebkitTextFillColor: theme.palette.text.disabled // Fix opacity Safari bug

  }), _defineProperty(_extends3, '&:-webkit-auto-fill', {
...
var InputBase = /*#__PURE__*/React.forwardRef(function InputBase(inProps, ref) {
  ...
  var ariaDescribedby = props['aria-describedby'],
      ...
      other = _objectWithoutProperties(props, ["aria-describedby", "autoComplete", "autoFocus", "className", "color", "defaultValue", "disabled", "endAdornment", "error", "fullWidth", "id", "inputComponent", "inputProps", "inputRef", "margin", "maxRows", "minRows", "multiline", "name", "onBlur", "onChange", "onClick", "onFocus", "onKeyDown", "onKeyUp", "placeholder", "readOnly", "renderSuffix", "rows", "size", "startAdornment", "type", "value"]);

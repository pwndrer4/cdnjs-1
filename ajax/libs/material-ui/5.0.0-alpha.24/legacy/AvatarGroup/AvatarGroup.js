...
var overridesResolver = function overridesResolver(props, styles) {
  return deepmerge(styles.root || {}, _defineProperty({}, "& .".concat(avatarGroupClasses.avatar), styles.avatar));
};
...
var AvatarGroupRoot = experimentalStyled('div', {}, {
  name: 'MuiAvatarGroup',
  slot: 'Root',
...
var AvatarGroupAvatar = experimentalStyled(Avatar, {}, {
  name: 'MuiAvatarGroup',
  slot: 'Avatar'
})(function (_ref3) {

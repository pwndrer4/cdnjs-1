...
var styles = function styles(theme) {
  return {
    ...
    root: (0, _extends2.default)({}, theme.typography.body2, {
      ...
      borderBottom: "1px solid\n    ".concat(theme.palette.mode === 'light' ? (0, _colorManipulator.lighten)((0, _colorManipulator.fade)(theme.palette.divider, 1), 0.88) : (0, _colorManipulator.darken)((0, _colorManipulator.fade)(theme.palette.divider, 1), 0.68)),
      textAlign: 'left',
      padding: 16
    }),

...
import { fade, withStyles, unstable_toUnitless as toUnitless, unstable_getUnit as getUnit, useThemeVariants } from '../styles';
export const styles = theme => {
  ...
  return {
    ...
    root: {
      ...
      backgroundColor: fade(theme.palette.text.primary, theme.palette.mode === 'light' ? 0.11 : 0.13),
      height: '1.2em'
    },

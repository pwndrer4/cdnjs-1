...
const defaultCheckedIcon = /*#__PURE__*/React.createElement(_RadioButtonIcon.default, {
  checked: true
});
const defaultIcon = /*#__PURE__*/React.createElement(_RadioButtonIcon.default, null);
const Radio = /*#__PURE__*/React.forwardRef(function Radio(props, ref) {
  const {
    ...
    size = 'medium'
        ...
        other = (0, _objectWithoutPropertiesLoose2.default)(props, ["checked", "classes", "color", "name", "onChange", "size"]);
  ...
  return /*#__PURE__*/React.createElement(_SwitchBase.default, (0, _extends2.default)({
    ...
    classes: {
      root: (0, _clsx.default)(classes.root, classes[`color${(0, _capitalize.default)(color)}`]),

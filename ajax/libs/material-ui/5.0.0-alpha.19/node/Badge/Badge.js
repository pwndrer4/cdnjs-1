...
const badgeClasses = (0, _extends2.default)({}, _unstyled.badgeUnstyledClasses, {
  colorError: (0, _unstyled.getBadgeUtilityClass)('colorError'),
  colorPrimary: (0, _unstyled.getBadgeUtilityClass)('colorPrimary'),
  colorSecondary: (0, _unstyled.getBadgeUtilityClass)('colorSecondary')
});
...
const overridesResolver = (props, styles) => {
  ...
  const styleOverrides = (0, _utils.deepmerge)(styles.root, {
...
const Badge = /*#__PURE__*/React.forwardRef(function Badge(inputProps, ref) {
  ...
  const classes = extendBadgeClasses((0, _extends2.default)({}, props, {
    invisible,
    color
  }));

...
process.env.NODE_ENV !== "production" ? Grid.propTypes = {
   ...
   */
  justify: (0, _deprecatedPropType.default)(_propTypes.default.oneOf(['center', 'flex-end', 'space-between', 'space-around', 'space-evenly']), 'Use `justifyContent` instead, the prop was renamed.'),

  /**
   * Defines the `justify-content` style property.
   * It is applied for all screen sizes.
   */
  justifyContent: _propTypes.default.oneOf(['center', 'flex-end', 'space-between', 'space-around', 'space-evenly']),

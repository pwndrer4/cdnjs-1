...
import { SliderUnstyled, SliderValueLabelUnstyled, sliderUnstyledClasses, getSliderUtilityClass, isHostComponent } from '@material-ui/unstyled';
import useThemeProps from '../styles/useThemeProps';
import experimentalStyled from '../styles/experimentalStyled';
import { alpha, lighten, darken } from '../styles/colorManipulator';
import capitalize from '../utils/capitalize';
export var sliderClasses = _extends({}, sliderUnstyledClasses, {
...
export var SliderThumb = experimentalStyled('span', {}, {
  ...
  })), _extends7), props.styleProps.orientation === 'vertical' && {
    marginLeft: -5,
    marginBottom: -6
  }, props.styleProps.color === 'secondary' && (_ref = {}, _defineProperty(_ref, "&:hover, &.".concat(sliderClasses.focusVisible), {
...
var extendSliderClasses = function extendSliderClasses(props) {
  var color = props.color,
      _props$classes = props.classes,
      classes = _props$classes === void 0 ? {} : _props$classes;
  return _extends({}, classes, {
    root: clsx(classes.root, getSliderUtilityClass["color".concat(capitalize(color))], sliderClasses["color".concat(capitalize(color))]),
    thumb: clsx(classes.thumb, getSliderUtilityClass["thumbColor".concat(capitalize(color))], sliderClasses["thumbColor".concat(capitalize(color))])
  });
};
...
var Slider = /*#__PURE__*/React.forwardRef(function Slider(inputProps, ref) {
  ...
  var classes = extendSliderClasses(_extends({}, props, {
    color: color
  }));

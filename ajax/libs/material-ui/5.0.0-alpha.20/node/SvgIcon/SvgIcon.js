...
const SvgIcon = /*#__PURE__*/React.forwardRef(function SvgIcon(props, ref) {
  ...
  return /*#__PURE__*/React.createElement(Component, (0, _extends2.default)({
    className: (0, _clsx.default)(classes.root, className, color !== 'inherit' && classes[`color${(0, _capitalize.default)(color)}`], fontSize !== 'medium' && classes[`fontSize${(0, _capitalize.default)(fontSize)}`]),
    focusable: "false",
    viewBox: viewBox,
    color: htmlColor,

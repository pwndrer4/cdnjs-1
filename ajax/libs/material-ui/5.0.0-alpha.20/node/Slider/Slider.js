...
const sliderClasses = (0, _extends2.default)({}, _unstyled.sliderUnstyledClasses, {
  colorPrimary: (0, _unstyled.getSliderUtilityClass)('colorPrimary'),
  colorSecondary: (0, _unstyled.getSliderUtilityClass)('colorSecondary'),
  thumbColorPrimary: (0, _unstyled.getSliderUtilityClass)('thumbColorPrimary'),
  thumbColorSecondary: (0, _unstyled.getSliderUtilityClass)('thumbColorSecondary')
});
...
const overridesResolver = (props, styles) => {
  ...
  const styleOverrides = (0, _extends2.default)({}, styles.root, styles[`color${(0, _capitalize.default)(color)}`], {
    ...
    [`& .${sliderClasses.thumb}`]: (0, _extends2.default)({}, styles.thumb, styles[`thumbColor${(0, _capitalize.default)(color)}`], {
      [`&.${sliderClasses.disabled}`]: styles.disabled
    })
  });
...
const SliderValueLabel = (0, _experimentalStyled.default)(_unstyled.SliderValueLabelUnstyled, {}, {
  name: 'Slider',
  slot: 'ValueLabel'
})(props => (0, _extends2.default)({
...
const extendSliderClasses = props => {
  ...
  return (0, _extends2.default)({}, classes, {
    root: (0, _clsx.default)(classes.root, _unstyled.getSliderUtilityClass[`color${(0, _capitalize.default)(color)}`], sliderClasses[`color${(0, _capitalize.default)(color)}`]),
    thumb: (0, _clsx.default)(classes.thumb, _unstyled.getSliderUtilityClass[`thumbColor${(0, _capitalize.default)(color)}`], sliderClasses[`thumbColor${(0, _capitalize.default)(color)}`])
  });
};
...
const Slider = /*#__PURE__*/React.forwardRef(function Slider(inputProps, ref) {
  ...
  const classes = extendSliderClasses((0, _extends2.default)({}, props, {
    color
  }));

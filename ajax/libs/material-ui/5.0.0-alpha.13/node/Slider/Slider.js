...
const Slider = /*#__PURE__*/React.forwardRef(function Slider(props, ref) {
  const {
    ...
    track = 'normal',
    value: valueProp,
    ValueLabelComponent: ValueLabelComponentProp = _ValueLabel.default,
    valueLabelDisplay = 'off',
    valueLabelFormat = Identity
  } = props,
        other = (0, _objectWithoutPropertiesLoose2.default)(props, ["aria-label", "aria-labelledby", "aria-valuetext", "classes", "className", "color", "component", "defaultValue", "disabled", "getAriaLabel", "getAriaValueText", "marks", "max", "min", "name", "onChange", "onChangeCommitted", "onMouseDown", "orientation", "scale", "step", "ThumbComponent", "track", "value", "ValueLabelComponent", "valueLabelDisplay", "valueLabelFormat"]);
  ...
  const handleFocusRef = (0, _useForkRef.default)(focusVisibleRef, sliderRef);
  const handleRef = (0, _useForkRef.default)(ref, handleFocusRef);
  ...
  const handleMouseOver = (0, _useEventCallback.default)(event => {
    const index = Number(event.currentTarget.getAttribute('data-index'));
    setOpen(index);
  });
  const handleMouseLeave = (0, _useEventCallback.default)(() => {
    setOpen(-1);
  });
  ...
  return /*#__PURE__*/React.createElement(Component, (0, _extends2.default)({
    ref: handleRef,
    className: (0, _clsx.default)(classes.root, classes[`color${(0, _capitalize.default)(color)}`], className, disabled && classes.disabled, marks.length > 0 && marks.some(mark => mark.label) && classes.marked, track === false && classes.trackFalse, orientation === 'vertical' && classes.vertical, track === 'inverted' && classes.trackInverted),
    ...
    return /*#__PURE__*/React.createElement(ValueLabelComponent, {
      ...
      className: (0, _clsx.default)(classes.thumb, classes[`thumbColor${(0, _capitalize.default)(color)}`], active === index && classes.active, disabled && classes.disabled, focusVisible === index && classes.focusVisible),

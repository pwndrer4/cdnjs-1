...
const overridesResolver = (props, styles) => {
  ...
  return (0, _utils.deepmerge)(styles.root || {}, (0, _extends2.default)({}, styles[variant], colorDefault && styles.colorDefault, {
...
const useUtilityClasses = styleProps => {
  ...
  return {
    root: (0, _clsx.default)(_avatarClasses.default.root, classes.root, (0, _avatarClasses.getAvatarUtilityClass)(variant), classes[variant], colorDefault && [_avatarClasses.default.colorDefault, classes.colorDefault]),

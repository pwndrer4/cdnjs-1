...
var overridesResolver = function overridesResolver(props, styles) {
  ...
  var colorDefault = props.colorDefault,
      _props$variant = props.variant,
      variant = _props$variant === void 0 ? 'circular' : _props$variant;
  return deepmerge(styles.root || {}, _extends({}, styles[variant], colorDefault && styles.colorDefault, (_extends2 = {}, _defineProperty(_extends2, "& .".concat(avatarClasses.img), styles.img), _defineProperty(_extends2, "& .".concat(avatarClasses.fallback), styles.fallback), _extends2)));
};
...
var useUtilityClasses = function useUtilityClasses(styleProps) {
  ...
  return {
    root: clsx(avatarClasses.root, classes.root, getAvatarUtilityClass(variant), classes[variant], colorDefault && [avatarClasses.colorDefault, classes.colorDefault]),

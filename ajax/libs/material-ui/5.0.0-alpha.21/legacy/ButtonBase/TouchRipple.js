...
var exitKeyframe = keyframes(_templateObject2());
var pulsateKeyframe = keyframes(_templateObject3());
export var TouchRippleRoot = experimentalStyled('span', {}, {
  name: 'MuiTouchRipple',
  slot: 'Root'
})({
  overflow: 'hidden',
...
export var TouchRippleRipple = experimentalStyled(Ripple, {}, {
  name: 'MuiTouchRipple',
  slot: 'Ripple'
})(_templateObject4(), touchRippleClasses.rippleVisible, enterKeyframe, DURATION, function (_ref) {
...
var TouchRipple = /*#__PURE__*/React.forwardRef(function TouchRipple(inProps, ref) {
  ...
  var startCommit = React.useCallback(function (params) {
    ...
    setRipples(function (oldRipples) {
      return [].concat(_toConsumableArray(oldRipples), [/*#__PURE__*/React.createElement(TouchRippleRipple, {
        key: nextKey.current,
        classes: {

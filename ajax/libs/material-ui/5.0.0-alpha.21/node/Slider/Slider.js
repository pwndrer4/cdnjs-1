...
const sliderClasses = (0, _extends2.default)({}, _unstyled.sliderUnstyledClasses, (0, _unstyled.generateUtilityClasses)('MuiSlider', ['colorPrimary', 'colorSecondary', 'thumbColorPrimary', 'thumbColorSecondary']));
...
const overridesResolver = (props, styles) => {
  ...
  return (0, _utils.deepmerge)(styles.root || {}, (0, _extends2.default)({}, styles[`color${(0, _capitalize.default)(color)}`], {
...
const extendUtilityClasses = styleProps => {
  ...
  return (0, _extends2.default)({}, classes, {
    root: (0, _clsx.default)(classes.root, (0, _unstyled.getSliderUtilityClass)(`color${(0, _capitalize.default)(color)}`), classes[`color${(0, _capitalize.default)(color)}`]),
    thumb: (0, _clsx.default)(classes.thumb, (0, _unstyled.getSliderUtilityClass)(`thumbColor${(0, _capitalize.default)(color)}`), classes[`thumbColor${(0, _capitalize.default)(color)}`])
  });
};

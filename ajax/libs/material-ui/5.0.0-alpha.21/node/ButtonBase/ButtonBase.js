...
var _buttonBaseClasses = _interopRequireDefault(require("./buttonBaseClasses"));
...
const overridesResolver = (props, styles) => {
  ...
  return (0, _utils.deepmerge)(styles.root || {}, (0, _extends2.default)({}, disabled && styles.disabled, focusVisible && styles.focusVisible));
};
...
const useUtilityClasses = styleProps => {
  ...
  return {
    root: (0, _clsx.default)(_buttonBaseClasses.default['root'], classes['root'], focusVisible && [_buttonBaseClasses.default['focusVisible'], classes['focusVisible'], focusVisibleClassName], disabled && [_buttonBaseClasses.default['disabled'], classes['disabled']])
  };
};
/**
...
const ButtonBase = /*#__PURE__*/React.forwardRef(function ButtonBase(inProps, ref) {
  ...
  const handleUserRef = (0, _useForkRef.default)(buttonRefProp, ref);
  const handleOwnRef = (0, _useForkRef.default)(focusVisibleRef, buttonRef);
  const handleRef = (0, _useForkRef.default)(handleUserRef, handleOwnRef);
  ...
  return /*#__PURE__*/React.createElement(ButtonBaseRoot, (0, _extends2.default)({
    as: ComponentProp,

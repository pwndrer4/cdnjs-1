...
const Drawer = /*#__PURE__*/React.forwardRef(function Drawer(props, ref) {
  const {
    ...
    variant = 'temporary'
        ...
        other = (0, _objectWithoutPropertiesLoose2.default)(props, ["anchor", "BackdropProps", "children", "classes", "className", "elevation", "ModalProps", "onClose", "open", "PaperProps", "SlideProps", "TransitionComponent", "transitionDuration", "variant"]);
  ...
  const drawer = /*#__PURE__*/React.createElement(_Paper.default, (0, _extends2.default)({
    elevation: variant === 'temporary' ? elevation : 0,
    square: true
  }, PaperProps, {
    className: (0, _clsx.default)(classes.paper, classes[`paperAnchor${(0, _capitalize.default)(anchor)}`], PaperProps.className, variant !== 'temporary' && classes[`paperAnchorDocked${(0, _capitalize.default)(anchor)}`])
  }), children);
  ...
  const slidingDrawer = /*#__PURE__*/React.createElement(TransitionComponent, (0, _extends2.default)({
    in: open,

...
const useUtilityClasses = styleProps => {
  ...
  return {
    ...
    startIcon: (0, _clsx.default)(_buttonClasses.default.startIcon, classes.startIcon, (0, _buttonClasses.getButtonUtilityClass)(`iconSize${(0, _capitalize.default)(size)}`)),
    endIcon: (0, _clsx.default)(_buttonClasses.default.endIcon, classes.endIcon, (0, _buttonClasses.getButtonUtilityClass)(`iconSize${(0, _capitalize.default)(size)}`))
  };
};

...
const overridesResolver = (props, styles) => {
  ...
  return deepmerge(styles.root || {}, _extends({}, disabled && styles.disabled, focusVisible && styles.focusVisible));
};
...
const useUtilityClasses = styleProps => {
  ...
  return {
    root: clsx(buttonBaseClasses['root'], classes['root'], focusVisible && [buttonBaseClasses['focusVisible'], classes['focusVisible'], focusVisibleClassName], disabled && [buttonBaseClasses['disabled'], classes['disabled']])
  };
};
/**

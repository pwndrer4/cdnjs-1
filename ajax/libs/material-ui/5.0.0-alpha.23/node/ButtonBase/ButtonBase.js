...
const overridesResolver = (props, styles) => {
  ...
  return (0, _utils.deepmerge)(styles.root || {}, (0, _extends2.default)({}, styleProps.disabled && styles.disabled, styleProps.focusVisible && styles.focusVisible));
};
...
const useUtilityClasses = styleProps => {
  ...
  const composedClasses = (0, _unstyled.unstable_composeClasses)({
    slots,
    classes,
    getUtilityClass: _buttonBaseClasses.getButtonBaseUtilityClass
  });

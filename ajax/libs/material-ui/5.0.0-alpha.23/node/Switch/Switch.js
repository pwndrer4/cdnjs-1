...
const Switch = /*#__PURE__*/React.forwardRef(function Switch(props, ref) {
  const {
    ...
    size = 'medium'
        ...
        other = (0, _objectWithoutPropertiesLoose2.default)(props, ["classes", "className", "color", "edge", "size"]);
  ...
  return /*#__PURE__*/React.createElement("span", {
    className: (0, _clsx.default)(classes.root, className, {
      ...
      'end': classes.edgeEnd
    }[edge], size === "small" && classes[`size${(0, _capitalize.default)(size)}`])
  }, /*#__PURE__*/React.createElement(_SwitchBase.default, (0, _extends2.default)({
    type: "checkbox",
    icon: icon,
    checkedIcon: icon,
    classes: {
      root: (0, _clsx.default)(classes.switchBase, classes[`color${(0, _capitalize.default)(color)}`]),
      input: classes.input,

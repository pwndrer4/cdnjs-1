...
const overridesResolver = (props, styles) => {
  ...
  return (0, _utils.deepmerge)(styles.root || {}, (0, _extends2.default)({}, styleProps.variant && styles[styleProps.variant], styleProps.color && styles[`color${(0, _capitalize.default)(styleProps.color)}`], styleProps.align && styles[`align${(0, _capitalize.default)(styleProps.align)}`], styleProps.display && styles[`display${(0, _capitalize.default)(styleProps.display)}`], styleProps.noWrap && styles.noWrap, styleProps.gutterBottom && styles.gutterBottom, styleProps.paragraph && styles.paragraph));
};
...
const useUtilityClasses = styleProps => {
  ...
  const slots = {
    root: ['root', variant, `color${(0, _capitalize.default)(color)}`, `align${(0, _capitalize.default)(align)}`, `display${(0, _capitalize.default)(display)}`, gutterBottom && 'gutterBottom', noWrap && 'noWrap', paragraph && 'paragraph']
  };
  return (0, _unstyled.unstable_composeClasses)({
    slots,
    classes,
    getUtilityClass: _typographyClasses.getTypographyUtilityClass
  });
};

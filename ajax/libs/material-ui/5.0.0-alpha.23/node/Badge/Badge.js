...
const overridesResolver = (props, styles) => {
  ...
  return (0, _utils.deepmerge)(styles.root || {}, {
    [`& .${badgeClasses.badge}`]: (0, _extends2.default)({}, styles.badge, styles[styleProps.variant], styles[`anchorOrigin${(0, _capitalize.default)(styleProps.anchorOrigin.vertical)}${(0, _capitalize.default)(styleProps.anchorOrigin.horizontal)}${(0, _capitalize.default)(styleProps.overlap)}`], styleProps.color !== 'default' && styles[`color${(0, _capitalize.default)(styleProps.color)}`], styleProps.invisible && styles.invisible)
  });
};

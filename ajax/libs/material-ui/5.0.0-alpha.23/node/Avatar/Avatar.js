...
const overridesResolver = (props, styles) => {
  ...
  return (0, _utils.deepmerge)(styles.root || {}, (0, _extends2.default)({}, styles[styleProps.variant], styleProps.colorDefault && styles.colorDefault, {
...
const useUtilityClasses = styleProps => {
  ...
  return (0, _unstyled.unstable_composeClasses)({
    slots,
    classes,
    getUtilityClass: _avatarClasses.getAvatarUtilityClass
  });
};

...
const overridesResolver = (props, styles) => {
  ...
  return (0, _utils.deepmerge)(styles.root || {}, (0, _extends2.default)({}, styles[styleProps.variant], styles[`${styleProps.variant}${(0, _capitalize.default)(styleProps.color)}`], styles[`size${(0, _capitalize.default)(styleProps.size)}`], styles[`${styleProps.variant}Size${(0, _capitalize.default)(styleProps.size)}`], styleProps.color === 'inherit' && styles.colorInherit, styleProps.disableElevation && styles.disableElevation, styleProps.fullWidth && styles.fullWidth, {
...
const useUtilityClasses = styleProps => {
  ...
  return (0, _unstyled.unstable_composeClasses)({
    slots,
    classes,
    getUtilityClass: _buttonClasses.getButtonUtilityClass
  });
};

...
const Accordion = /*#__PURE__*/React.forwardRef(function Accordion(props, ref) {
  const {
    ...
    TransitionProps
        ...
        other = (0, _objectWithoutPropertiesLoose2.default)(props, ["children", "classes", "className", "defaultExpanded", "disabled", "expanded", "onChange", "square", "TransitionComponent", "TransitionProps"]);

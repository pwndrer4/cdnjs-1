...
var Icon = /*#__PURE__*/React.forwardRef(function Icon(props, ref) {
  var _props$baseClassName = props.baseClassName,
      ...
      other = _objectWithoutProperties(props, ["baseClassName", "classes", "className", "color", "component", "fontSize"]);

  return /*#__PURE__*/React.createElement(Component, _extends({
    className: clsx(baseClassName, // Prevent the translation of the text content.
    // The font relies on the exact text content to render the icon.
    'notranslate', classes.root, className, color !== 'inherit' && classes["color".concat(capitalize(color))], fontSize !== 'medium' && classes["fontSize".concat(capitalize(fontSize))]),
    "aria-hidden": true,
    ref: ref
  }, other));
});

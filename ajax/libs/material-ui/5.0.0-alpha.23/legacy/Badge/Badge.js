...
var overridesResolver = function overridesResolver(props, styles) {
  ...
  return deepmerge(styles.root || {}, _defineProperty({}, "& .".concat(badgeClasses.badge), _extends({}, styles.badge, styles[styleProps.variant], styles["anchorOrigin".concat(capitalize(styleProps.anchorOrigin.vertical)).concat(capitalize(styleProps.anchorOrigin.horizontal)).concat(capitalize(styleProps.overlap))], styleProps.color !== 'default' && styles["color".concat(capitalize(styleProps.color))], styleProps.invisible && styles.invisible)));
};

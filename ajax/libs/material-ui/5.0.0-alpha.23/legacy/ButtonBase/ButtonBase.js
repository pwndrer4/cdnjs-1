...
var overridesResolver = function overridesResolver(props, styles) {
  ...
  return deepmerge(styles.root || {}, _extends({}, styleProps.disabled && styles.disabled, styleProps.focusVisible && styles.focusVisible));
};
...
var useUtilityClasses = function useUtilityClasses(styleProps) {
  ...
  var composedClasses = composeClasses({
    slots: slots,
    classes: classes,

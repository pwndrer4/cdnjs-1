...
(function (global, factory) {
    ...
    function Transitioner (prev, next, dir, ref) {
        ...
        return {
            ...
            getActives: function() {
                return [next].concat(uikitUtil.children(list).filter(function (slide, i) {
                    var slideLeft = getElLeft(slide, list);
                    return slideLeft > from && slideLeft + uikitUtil.offset(slide).width <= uikitUtil.offset(list).width + from;
                }));
            },
    ...
    function getWidth(list) {
        return uikitUtil.children(list).reduce(function (right, el) { return uikitUtil.offset(el).width + right; }, 0);
    }

    function getMaxWidth(list) {
        return uikitUtil.children(list).reduce(function (right, el) { return Math.max(right, uikitUtil.offset(el).width); }, 0);
    }
    ...
    var Component = {
        ...
        computed: {
            ...
            maxIndex: function() {
                ...
                return this.length - uikitUtil.findIndex(this.slides.slice().reverse(), function (el) { return getElLeft(el, this$1.list) < max; });
            },

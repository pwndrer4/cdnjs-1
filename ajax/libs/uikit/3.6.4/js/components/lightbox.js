    ...
    var SliderDrag = {
        ...
        methods: {
            ...
            move: function(e) {
                ...
                if (!this.dragging && uikitUtil.hasTouch) {
                    uikitUtil.on(this.list, 'touchmove', preventDefault, {passive: false});
                }
                ...
                uikitUtil.off(this.list, 'touchmove', preventDefault, {passive: false});

    ...
    var Togglable = {
        ...
        methods: {
            ...
            isToggled: function(el) {
                ...
                return uikitUtil.hasClass(this.clsEnter)
                    ? true
                    : uikitUtil.hasClass(this.clsLeave)
                        ? false
                        : this.cls
            ...
            _toggleElement: function(el, show, animate) {
                ...
                show = uikitUtil.isBoolean(show) ? show : !this.isToggled(el);
                ...
                uikitUtil.addClass(el, show ? this.clsEnter : this.clsLeave);
    ...
    var Component = {
        ...
        methods: {
            ...
            show: function() {
                ...
                this._unbind = uikitUtil.once(document, 'show keydown', this.hide, false, function (e) { return e.type === 'keydown' && e.keyCode === 27

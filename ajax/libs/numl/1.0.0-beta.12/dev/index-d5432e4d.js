...
const BEHAVIORS = {
  focus: () => extractModule(import('./focus-c609561c.js')),
  hover: () => extractModule(import('./hover-c6902bdc.js')),
  listbox: () => extractModule(import('./listbox-ae7f6a51.js')),
  option: () => extractModule(import('./option-6265f12f.js')),
  active: () => extractModule(import('./active-4a525e2e.js')),
  fixate: () => extractModule(Promise.resolve().then(function () { return fixate; })),
  orient: () => extractModule(import('./orient-175850a0.js')),
  popup: () => extractModule(import('./popup-4dde950d.js')),
  control: () => extractModule(import('./control-09bfd85e.js')),
  radiogroup: () => extractModule(import('./radiogroup-fb1fc33d.js')),
  action: () => extractModule(import('./action-4dfe73a0.js')),
  label: () => extractModule(import('./label-83ed669e.js')),
  code: () => extractModule(import('./code-b9ee5fc4.js')),
  markdown: () => extractModule(import('./markdown-53a23d09.js')),
  datetime: () => extractModule(import('./datetime-a0903123.js')),
  number: () => extractModule(import('./number-4c4af8eb.js')),
  slider: () => extractModule(import('./slider-61f55a44.js')),
  numinput: () => extractModule(import('./numinput-d8f4377c.js')),
  input: () => extractModule(import('./input-07f50638.js')),
  textarea: () => extractModule(import('./textarea-a188136b.js')),
  fileinput: () => extractModule(import('./fileinput-915eae60.js')),
  icon: () => extractModule(import('./icon-e12088c9.js')),
  svg: () => extractModule(import('./svg-a10d0907.js')),
  image: () => extractModule(import('./image-8d90ea55.js')),
  debug: () => extractModule(import('./debug-0554da4a.js')),
  debugger: () => extractModule(import('./debugger-21f133a9.js')),
  form: () => extractModule(import('./form-e02c67fd.js')),
  validator: () => extractModule(import('./validator-cf0de65d.js')),
  group: () => Promise.resolve(GroupBehavior),
  tooltip: () => extractModule(import('./tooltip-d561a824.js')),
  progressbar: () => extractModule(import('./progressbar-0b0108b5.js')),
  value: () => extractModule(import('./value-45c0f108.js')),
  datepicker: () => extractModule(import('./datepicker-a4f86d1d.js')),
  dateinput: () => extractModule(import('./dateinput-d69e2d18.js')),
  inputgroup: () => extractModule(import('./inputgroup-facfe040.js')),
  menu: () => extractModule(import('./menu-4951f9be.js')),
  menuitem: () => extractModule(import('./menuitem-121ce63a.js')),
  offset: () => extractModule(import('./offset-80df712e.js')),
  appear: () => extractModule(import('./appear-3d48a624.js')),
  hotkey: () => extractModule(import('./hotkey-4852a00a.js')),
  current: () => extractModule(import('./current-c92fb477.js')),
};

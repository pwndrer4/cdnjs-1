...
const BEHAVIORS = {
  focus: () => extractModule(import('./focus-a4d67f2b.js')),
  hover: () => extractModule(import('./hover-f7219b6d.js')),
  listbox: () => extractModule(import('./listbox-0df7f7d9.js')),
  option: () => extractModule(import('./option-eb0a001d.js')),
  active: () => extractModule(import('./active-ed169e6a.js')),
  fixate: () => extractModule(Promise.resolve().then(function () { return fixate; })),
  orient: () => extractModule(import('./orient-ab0b659c.js')),
  popup: () => extractModule(import('./popup-04b35053.js')),
  control: () => extractModule(import('./control-ad243b47.js')),
  radiogroup: () => extractModule(import('./radiogroup-66e3d76d.js')),
  action: () => extractModule(import('./action-eb1eedd6.js')),
  label: () => extractModule(import('./label-8dead6c5.js')),
  code: () => extractModule(import('./code-cd041f51.js')),
  markdown: () => extractModule(import('./markdown-3596f87a.js')),
  datetime: () => extractModule(import('./datetime-d076383e.js')),
  number: () => extractModule(import('./number-03d73369.js')),
  slider: () => extractModule(import('./slider-dd75db97.js')),
  numinput: () => extractModule(import('./numinput-75a62fac.js')),
  input: () => extractModule(import('./input-84745739.js')),
  textarea: () => extractModule(import('./textarea-26ebc93e.js')),
  fileinput: () => extractModule(import('./fileinput-41a491ef.js')),
  icon: () => extractModule(import('./icon-24d9ae19.js')),
  svg: () => extractModule(import('./svg-98ddc2a7.js')),
  image: () => extractModule(import('./image-3bfb965e.js')),
  debug: () => extractModule(import('./debug-efad54e8.js')),
  debugger: () => extractModule(import('./debugger-18506f0c.js')),
  form: () => extractModule(import('./form-410a8e0e.js')),
  validator: () => extractModule(import('./validator-7cdb657e.js')),
  group: () => Promise.resolve(GroupBehavior),
  tooltip: () => extractModule(import('./tooltip-c2552f6e.js')),
  progressbar: () => extractModule(import('./progressbar-89d6ca7c.js')),
  value: () => extractModule(import('./value-111341e1.js')),
  datepicker: () => extractModule(import('./datepicker-49ee54f7.js')),
  dateinput: () => extractModule(import('./dateinput-fb87dfef.js')),
  inputgroup: () => extractModule(import('./inputgroup-8bbf83cc.js')),
  menu: () => extractModule(import('./menu-2b59ff4b.js')),
  menuitem: () => extractModule(import('./menuitem-2a7eb721.js')),
  offset: () => extractModule(import('./offset-ba0f39ae.js')),
  appear: () => extractModule(import('./appear-27b7dd38.js')),
  hotkey: () => extractModule(import('./hotkey-5af95414.js')),
  current: () => extractModule(import('./current-a630ebdb.js')),
};

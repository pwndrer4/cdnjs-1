import { S as SvelteComponent, i as init, s as safe_not_equal, e as element, a as space, b as set_custom_element_data, c as insert, d as append, l as listen, n as noop, f as detach, k as createEventDispatcher } from './index-23c131fd.js';

/* src/components/dateinput.svelte generated by Svelte v3.29.4 */
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty & /*mode*/ 2) {
			 $$invalidate(9, isRange = mode === "range");
		}

		if ($$self.$$.dirty & /*host, isRange*/ 576) {
			 host.setAttribute("type", isRange ? "daterange" : "date");
		}
	};

	return [placeholder, mode, value, begin, end, handleInput, host];
}

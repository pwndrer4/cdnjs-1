...
const RGB_COLORS = ['text', 'bg', 'subtle', 'special', 'special-text', 'special-bg', 'shadow', 'special-shadow', 'outline', 'dark'];
...
function getVarValue(varName, context) {
  return context[`var:${varName}`] ? context[`var:${varName}`].value : '';
}

function composeVarsValue(value, context, zonesNumber) {
...
function getResponsiveValues(value, count) {
  const values = value.split('|');
  const outValues = [];
...
const BASE_COLOR = 'var(--nu-local-text-color, var(--nu-text-color))';
const SPECIAL_BASE_COLOR = 'var(--nu-local-special-text-color, var(--nu-special-text-color))';
    ...
    generator(attrs, allAttrs) {
      ...
      return {
        'box-shadow': allAttrs
          ...
          .map((attr) => `var(--nu-local-${STYLE_MAP$1[attr]}-shadow)`)
          .join(', '),
      };
    },
  };
...
const BEHAVIORS = {
  focus: () => extractModule(import('./focus-af535175.js')),
  hover: () => extractModule(import('./hover-f589506b.js')),
  listbox: () => extractModule(import('./listbox-972337ab.js')),
  option: () => extractModule(import('./option-e51f3cf0.js')),
  active: () => extractModule(import('./active-e3f32d9a.js')),
  fixate: () => extractModule(Promise.resolve().then(function () { return fixate; })),
  orient: () => extractModule(import('./orient-aa8cb3db.js')),
  popup: () => extractModule(import('./popup-898dbba6.js')),
  control: () => extractModule(import('./control-42ac1834.js')),
  radiogroup: () => extractModule(import('./radiogroup-bad55fc5.js')),
  action: () => extractModule(import('./action-ff205e49.js')),
  label: () => extractModule(import('./label-83d2332a.js')),
  code: () => extractModule(import('./code-bb8622b5.js')),
  markdown: () => extractModule(import('./markdown-d5274994.js')),
  datetime: () => extractModule(import('./datetime-6a5d6c2b.js')),
  number: () => extractModule(import('./number-dd6fce63.js')),
  slider: () => extractModule(import('./slider-5c954e0c.js')),
  numinput: () => extractModule(import('./numinput-0dcbc156.js')),
  input: () => extractModule(import('./input-2cfd2f78.js')),
  textarea: () => extractModule(import('./textarea-677eca4d.js')),
  fileinput: () => extractModule(import('./fileinput-369218b8.js')),
  icon: () => extractModule(import('./icon-cd04fe20.js')),
  svg: () => extractModule(import('./svg-978a2b3d.js')),
  image: () => extractModule(import('./image-50f0a875.js')),
  debug: () => extractModule(import('./debug-7f918c10.js')),
  debugger: () => extractModule(import('./debugger-1b062704.js')),
  form: () => extractModule(import('./form-a6cd1dd3.js')),
  validator: () => extractModule(import('./validator-5519c3d3.js')),
  group: () => Promise.resolve(GroupBehavior),
  tooltip: () => extractModule(import('./tooltip-f2c4414b.js')),
  progressbar: () => extractModule(import('./progressbar-5ffc61d0.js')),
  value: () => extractModule(import('./value-d609332b.js')),
  datepicker: () => extractModule(import('./datepicker-f9799660.js')),
  dateinput: () => extractModule(import('./dateinput-4d48707a.js')),
  inputgroup: () => extractModule(import('./inputgroup-e05fb3c3.js')),
  menu: () => extractModule(import('./menu-9d0b08f2.js')),
  menuitem: () => extractModule(import('./menuitem-777af76a.js')),
  offset: () => extractModule(import('./offset-88b5053f.js')),
  appear: () => extractModule(import('./appear-8bf5947b.js')),
  hotkey: () => extractModule(import('./hotkey-0f50cdf8.js')),
  current: () => extractModule(import('./current-c49c34c2.js')),
};
...
const DEFAULT_TIMING = 'calc(var(--nu-transition-enabler) * var(--nu-transition))';
 ...
 * @abstract
 */
class NuElement extends NuAbstract {
  static get nuTag() {
...
class NuRoot extends NuElement {
  static get nuTag() {
    return 'nu-root';
  }
...
class NuFlow extends NuElement {
  static get nuTag() {
    return 'nu-flow';
  }
...
class NuStatus extends NuElement {
  static get nuTag() {
    return 'nu-status';
  }
...
class NuLine extends NuElement {
  static get nuTag() {
    return 'nu-line';
  }
...
class NuInline extends NuElement {
  static get nuTag() {
    return 'nu-in';
  }
...
class NuContents extends NuElement {
  static get nuTag() {
    return 'nu-contents';
  }
...
class NuHeading extends NuElement {
  static get nuTag() {
    return 'nu-heading';
  }
...
class NuDescription extends NuElement {
  static get nuTag() {
...
class NuSpacer extends NuElement {
  static get nuTag() {
    return 'nu-spacer';
  }
...
class NuIcon extends NuElement {
  static get nuTag() {
    return 'nu-icon';
  }
...
class NuTable extends NuElement {
  static get nuTag() {
    return 'nu-table';
  }
...
class NuRowGroup extends NuElement {
  static get nuTag() {
    return 'nu-rowgroup';
  }
...
class NuCell extends NuElement {
  static get nuTag() {
    return 'nu-cell';
  }
...
class NuGroup extends NuElement {
  static get nuTag() {
    return 'nu-group';
  }
...
class NuAction extends NuElement {
  static get nuTag() {
...
class NuOption extends NuElement {
  static get nuTag() {
    return 'nu-option';
  }
...
class NuList extends NuElement {
  static get nuTag() {
    return 'nu-list';
  }
...
class NuListItem extends NuElement {
  static get nuTag() {
    return 'nu-listitem';
  }
...
class NuMenu extends NuElement {
  static get nuTag() {
    return 'nu-menu';
  }
...
class NuBlockQuote extends NuElement {
  static get nuTag() {
...
class NuMark extends NuElement {
  static get nuTag() {
    return 'nu-mark';
  }
...
class NuCircle extends NuElement {
  static get nuTag() {
    return 'nu-circle';
  }
...
class NuDateTime extends NuElement {
  static get nuTag() {
    return 'nu-datetime';
  }
...
class NuFileInput extends NuElement {
  static get nuTag() {
    return 'nu-fileinput';
  }
...
class NuCode extends NuElement {
  static get nuTag() {
    return 'nu-code';
  }
...
class NuProgressBar extends NuElement {
  static get nuTag() {
...
class NuDatePicker extends NuElement {
  static get nuTag() {
...
class NuTooltip extends NuElement {
  static get nuTag() {
    return 'nu-tooltip';
  }
...
class NuMarkdown extends NuElement {
  static get nuTag() {
    return 'nu-markdown';
  }
...
class NuSlider extends NuElement {
  static get nuTag() {
    return 'nu-slider';
  }
...
class NuLabel extends NuElement {
  static get nuTag() {
    return 'nu-label';
  }
...
class NuCheck extends NuElement {
  static get nuTag() {
    return 'nu-check';
  }
...
class NuValue extends NuElement {
  static get nuTag() {
    return 'nu-value';
  }
...
function featherIconsLoader(name) {
  return extractModule(import('./icons-05940bef.js'))
    .then(icons => {
...
function evaIconsLoader(name) {
  return extractModule(import('./eva-icons-52227108.js'))
    .then(icons => {
...
const BASE_PROPS = NuElement.nuPropsList.reduce((props, name) => {
  props[name] = null;
...
const GENERATORS$1 = NuElement.prototype.nuGenerators;
...
export { define as $, ALIAS_ATTR as A, Behavior as B, parseAllValues as C, svgElement as D, extractModule as E, toCamelCase as F, hideEffect as G, isTouch as H, Icons as I, setTransitionTimeout as J, isValidDate as K, Nude as L, NuAbstract as M, NUMBER_TYPE as N, NuAction as O, elements as P, scheme as Q, ROOT as R, Svg as S, contrast as T, reduceMotion as U, CONTEXT as V, WidgetBehavior as W, behaviors as X, requestIdleCallback as Y, helpers as Z, styles as _, scrollParentToChild as a, assign$1 as a0, units as a1, hue as a2, FLEX_GAP_SUPPORTED as a3, STATES_MAP as a4, CUSTOM_UNITS as a5, ROOT_CONTEXT as a6, BOOL_TYPE as b, deepQuery as c, deepQueryAll as d, isFocusable as e, fixPosition as f, asyncDebounce as g, h, isEqual as i, Routing as j, enableFocus as k, log as l, generateId as m, query as n, removeInnerRef as o, setInnerRef as p, queryById as q, resetScroll as r, setAttr as s, setAriaRef as t, error as u, devMode as v, warn$1 as w, isNoValue as x, getFloatFromAttr as y, fixture as z };

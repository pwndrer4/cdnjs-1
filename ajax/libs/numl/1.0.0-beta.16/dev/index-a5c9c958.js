...
const BEHAVIORS = {
  focus: () => extractModule(import('./focus-7560d12c.js')),
  hover: () => extractModule(import('./hover-58f93a45.js')),
  listbox: () => extractModule(import('./listbox-187db5be.js')),
  option: () => extractModule(import('./option-e02024d0.js')),
  active: () => extractModule(import('./active-87e1b934.js')),
  fixate: () => extractModule(Promise.resolve().then(function () { return fixate; })),
  orient: () => extractModule(import('./orient-2af485e6.js')),
  popup: () => extractModule(import('./popup-3ebcb464.js')),
  control: () => extractModule(import('./control-04d86dbd.js')),
  radiogroup: () => extractModule(import('./radiogroup-526f6bb1.js')),
  action: () => extractModule(import('./action-484e0074.js')),
  label: () => extractModule(import('./label-fe8c14e5.js')),
  code: () => extractModule(import('./code-17cc67a5.js')),
  markdown: () => extractModule(import('./markdown-49f28dc4.js')),
  datetime: () => extractModule(import('./datetime-d17d68a0.js')),
  number: () => extractModule(import('./number-3c7005b8.js')),
  slider: () => extractModule(import('./slider-9981a4b3.js')),
  numinput: () => extractModule(import('./numinput-ee29a4d5.js')),
  input: () => extractModule(import('./input-f89d48e7.js')),
  textarea: () => extractModule(import('./textarea-9ef09630.js')),
  fileinput: () => extractModule(import('./fileinput-13145fd2.js')),
  icon: () => extractModule(import('./icon-27eeaf5a.js')),
  svg: () => extractModule(import('./svg-6997ff40.js')),
  image: () => extractModule(import('./image-f7cb1f80.js')),
  debug: () => extractModule(import('./debug-81ad4351.js')),
  debugger: () => extractModule(import('./debugger-c5b34724.js')),
  form: () => extractModule(import('./form-80b425cc.js')),
  validator: () => extractModule(import('./validator-ded931a5.js')),
  group: () => Promise.resolve(GroupBehavior),
  tooltip: () => extractModule(import('./tooltip-2e80c368.js')),
  progressbar: () => extractModule(import('./progressbar-9b2c0bd0.js')),
  value: () => extractModule(import('./value-1ac38192.js')),
  datepicker: () => extractModule(import('./datepicker-0da0b64b.js')),
  dateinput: () => extractModule(import('./dateinput-d74ccb75.js')),
  inputgroup: () => extractModule(import('./inputgroup-a449d8b6.js')),
  menu: () => extractModule(import('./menu-b45a0a26.js')),
  menuitem: () => extractModule(import('./menuitem-9e148b90.js')),
  offset: () => extractModule(import('./offset-4b4e0fb9.js')),
  appear: () => extractModule(import('./appear-e27cfca2.js')),
  hotkey: () => extractModule(import('./hotkey-e6b2c6c9.js')),
  current: () => extractModule(import('./current-23a84d31.js')),
};

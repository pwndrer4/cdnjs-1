...
const BEHAVIORS = {
  focus: () => extractModule(import('./focus-0f9dc208.js')),
  hover: () => extractModule(import('./hover-09d4a196.js')),
  listbox: () => extractModule(import('./listbox-2f29334d.js')),
  option: () => extractModule(import('./option-b9f1ac1a.js')),
  active: () => extractModule(import('./active-5e7daab7.js')),
  fixate: () => extractModule(Promise.resolve().then(function () { return fixate; })),
  orient: () => extractModule(import('./orient-23054c7c.js')),
  popup: () => extractModule(import('./popup-0cb985fb.js')),
  control: () => extractModule(import('./control-b6ac5843.js')),
  radiogroup: () => extractModule(import('./radiogroup-fa6732c9.js')),
  action: () => extractModule(import('./action-e5ec6c9a.js')),
  label: () => extractModule(import('./label-41091280.js')),
  code: () => extractModule(import('./code-fad61b44.js')),
  markdown: () => extractModule(import('./markdown-a64b0c03.js')),
  datetime: () => extractModule(import('./datetime-84a57741.js')),
  number: () => extractModule(import('./number-e11ab87f.js')),
  slider: () => extractModule(import('./slider-bafe9d07.js')),
  numinput: () => extractModule(import('./numinput-72650ddc.js')),
  input: () => extractModule(import('./input-56b01b28.js')),
  textarea: () => extractModule(import('./textarea-320d5811.js')),
  fileinput: () => extractModule(import('./fileinput-a1baedf4.js')),
  icon: () => extractModule(import('./icon-76da958e.js')),
  svg: () => extractModule(import('./svg-69f8fb04.js')),
  image: () => extractModule(import('./image-71815118.js')),
  debug: () => extractModule(import('./debug-c1ed9db6.js')),
  debugger: () => extractModule(import('./debugger-d89ca54b.js')),
  form: () => extractModule(import('./form-702e1419.js')),
  validator: () => extractModule(import('./validator-27f068d9.js')),
  group: () => Promise.resolve(GroupBehavior),
  tooltip: () => extractModule(import('./tooltip-c68dcaaf.js')),
  progressbar: () => extractModule(import('./progressbar-ced99939.js')),
  value: () => extractModule(import('./value-8d155094.js')),
  datepicker: () => extractModule(import('./datepicker-e232c0aa.js')),
  dateinput: () => extractModule(import('./dateinput-36e91158.js')),
  inputgroup: () => extractModule(import('./inputgroup-a0d4d166.js')),
  menu: () => extractModule(import('./menu-31fd5585.js')),
  menuitem: () => extractModule(import('./menuitem-152f15f3.js')),
  offset: () => extractModule(import('./offset-949b2c7f.js')),
  appear: () => extractModule(import('./appear-86e82084.js')),
  hotkey: () => extractModule(import('./hotkey-9008b76f.js')),
  current: () => extractModule(import('./current-5c039079.js')),
};

...
function create_each_block_3(ctx) {
	...
	return {
		c() {
			...
			set_custom_element_data(nu_option, "disabled", nu_option_disabled_value = !/*isMonthInRange*/ ctx[17](/*month*/ ctx[69], /*beginDate*/ ctx[5], /*endDate*/ ctx[6])
			? ""
			: undefined);
		},
		m(target, anchor) {
		...
		p(ctx, dirty) {
			...
			if (dirty[0] & /*months, beginDate, endDate*/ 352 && nu_option_disabled_value !== (nu_option_disabled_value = !/*isMonthInRange*/ ctx[17](/*month*/ ctx[69], /*beginDate*/ ctx[5], /*endDate*/ ctx[6])
			? ""
			: undefined)) {
...
function create_each_block_2(ctx) {
	...
	return {
		c() {
			...
			set_custom_element_data(nu_option, "disabled", nu_option_disabled_value = !/*isMonthInRange*/ ctx[17](/*year*/ ctx[66], /*beginDate*/ ctx[5], /*endDate*/ ctx[6])
			? ""
			: undefined);
		},
		m(target, anchor) {
		...
		p(ctx, dirty) {
			...
			if (dirty[0] & /*years, beginDate, endDate*/ 608 && nu_option_disabled_value !== (nu_option_disabled_value = !/*isMonthInRange*/ ctx[17](/*year*/ ctx[66], /*beginDate*/ ctx[5], /*endDate*/ ctx[6])
			? ""
			: undefined)) {
				set_custom_element_data(nu_option, "disabled", nu_option_disabled_value);
			}
...
function create_each_block(ctx) {
	...
	function tap_handler(...args) {
		return /*tap_handler*/ ctx[34](/*day*/ ctx[60], ...args);
	}

	function mouseover_handler(...args) {
		return /*mouseover_handler*/ ctx[35](/*day*/ ctx[60], ...args);
	}
	...
	return {
		...
		p(new_ctx, dirty) {
			ctx = new_ctx;
			if (dirty[0] & /*monthDays*/ 128 && t0_value !== (t0_value = /*day*/ ctx[60].date.getDate() + "")) set_data(t0, t0_value);

			if (dirty[0] & /*monthDays*/ 128 && nu_btn_as_value !== (nu_btn_as_value = /*day*/ ctx[60].modifiers)) {
...
function create_if_block(ctx) {
	...
	return {
		...
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = [
					listen(nu_btn0, "tap", /*tap_handler_1*/ ctx[36]),
					listen(nu_btn1, "tap", /*tap_handler_2*/ ctx[37]),
					listen(nu_btn2, "tap", /*tap_handler_3*/ ctx[38])
				];
		...
		p(ctx, dirty) {
			...
			if (dirty[0] & /*navQuater*/ 16) set_data(t3, /*navQuater*/ ctx[4]);
...
function create_fragment(ctx) {
	...
	let each_value = /*monthDays*/ ctx[7];
	let each_blocks = [];
	...
	return {
		c() {
			...
			set_custom_element_data(nu_attrs2, "padding", ".5x .25x .5x .75x");
			...
			set_custom_element_data(nu_attrs5, "radius", nu_attrs5_radius_value = /*isRange*/ ctx[3]
			? "1r :hover[1r 0 0 1r]"
			: "1r :hover[1r]");

			set_custom_element_data(nu_attrs5, "text", "sb");
			set_custom_element_data(nu_attrs5, "shadow", "0 0 0 1bw #white");
			...
			set_custom_element_data(nu_attrs6, "shadow", "0 0 0 1bw #border");
			...
			set_custom_element_data(nu_attrs12, "radius", nu_attrs12_radius_value = /*isRange*/ ctx[3] ? "0 :hover[0 1r 1r 0]" : "1r");
		...
		m(target, anchor) {
			...
			/*nu_popuplistbox0_binding*/ ctx[30](nu_popuplistbox0);
			append(nu_pane0, t6);
			...
			/*nu_popuplistbox1_binding*/ ctx[32](nu_popuplistbox1);
			append(nu_pane2, t9);
			...
			if (!mounted) {
				dispose = [
					...
					listen(nu_btn0, "input", /*input_handler*/ ctx[31]),
					listen(nu_btn1, "input", /*input_handler_1*/ ctx[33]),
		...
		p(ctx, dirty) {
			...
			if (dirty[0] & /*months, isMonthInRange, beginDate, endDate*/ 131424) {
			...
			if (dirty[0] & /*years, isMonthInRange, beginDate, endDate*/ 131680) {
			...
			if (dirty[0] & /*isRange*/ 8 && nu_attrs5_radius_value !== (nu_attrs5_radius_value = /*isRange*/ ctx[3]
			? "1r :hover[1r 0 0 1r]"
			: "1r :hover[1r]")) {
				set_custom_element_data(nu_attrs5, "radius", nu_attrs5_radius_value);
			}

			if (dirty[0] & /*isRange*/ 8 && nu_attrs12_radius_value !== (nu_attrs12_radius_value = /*isRange*/ ctx[3] ? "0 :hover[0 1r 1r 0]" : "1r")) {
				set_custom_element_data(nu_attrs12, "radius", nu_attrs12_radius_value);
			}

			if (dirty[0] & /*monthDays, selectRange, setHover*/ 3145856) {
				each_value = /*monthDays*/ ctx[7];
				let i;
		...
		d(detaching) {
			...
			/*nu_popuplistbox0_binding*/ ctx[30](null);
			destroy_each(each_blocks_2, detaching);
			/*nu_popuplistbox1_binding*/ ctx[32](null);
...
function instance($$self, $$props, $$invalidate) {
	...
	function selectRange(date) {
		if (isRange) {
			if (fromDate && !toDate && (isAfter(date, fromDate) || isSameDay(date, fromDate))) {
				$$invalidate(40, toDate = date);
				dispatch("input", [fromDate, toDate]);
			} else {
				$$invalidate(39, fromDate = date);
				$$invalidate(40, toDate = null);
			}
		} else {
			$$invalidate(39, fromDate = date);
			$$invalidate(40, toDate = date);
	...
	function setRange(range) {
		$$invalidate(39, fromDate = startOfDay(range[0]));
		$$invalidate(40, toDate = startOfDay(range[1]));
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty[0] & /*mode*/ 268435456) {
			 $$invalidate(3, isRange = mode === "range");
		}
		...
		if ($$self.$$.dirty[0] & /*host, isRange*/ 536870920) {
			 host.setAttribute("type", isRange ? "daterange" : "date");
		}

		if ($$self.$$.dirty[0] & /*navDate*/ 1) {
			 $$invalidate(4, navQuater = getQuarter(navDate));
		}

		if ($$self.$$.dirty[0] & /*navDate*/ 1) {
			 $$invalidate(44, navMonthStartDate = navDate);
		}

		if ($$self.$$.dirty[0] & /*navDate*/ 1) {
			 $$invalidate(45, navMonthEndDate = endOfMonth(navDate));
		}

		if ($$self.$$.dirty[0] & /*locale*/ 33554432) {
			 $$invalidate(46, weekStartDate = weekStart(decodeLocale(locale)[4]));
		}

		if ($$self.$$.dirty[0] & /*navDate*/ 1 | $$self.$$.dirty[1] & /*weekStartDate*/ 32768) {
			 $$invalidate(47, navStartDate = startOfWeek(navDate, { weekStartsOn: weekStartDate }));
		}

		if ($$self.$$.dirty[1] & /*navMonthEndDate, weekStartDate, navStartDate*/ 114688) {
			 $$invalidate(48, navEndDate = (() => {
		...
		if ($$self.$$.dirty[0] & /*end, beginDate*/ 134217760) {
			 $$invalidate(6, endDate = (() => {
				let date;
		...
		if ($$self.$$.dirty[0] & /*beginDate, endDate*/ 96 | $$self.$$.dirty[1] & /*navStartDate, navEndDate, navMonthStartDate, navMonthEndDate, fromDate, toDate, hoverDate*/ 222976) {
			 $$invalidate(7, monthDays = (() => {
				let arr = [];
		...
		if ($$self.$$.dirty[0] & /*navDate*/ 1 | $$self.$$.dirty[1] & /*touched*/ 2048) {
		...
		if ($$self.$$.dirty[0] & /*beginDate, endDate, navDate*/ 97 | $$self.$$.dirty[1] & /*touched*/ 2048) {
			 $$invalidate(9, years = (() => {
				if (!touched) return [];
				const list = [];
		...
		if ($$self.$$.dirty[0] & /*navDate, beginDate, endDate*/ 97) {
		...
		if ($$self.$$.dirty[0] & /*beginDate, navDate, endDate*/ 97) {

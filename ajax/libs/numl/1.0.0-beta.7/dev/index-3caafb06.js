...
const BEHAVIORS = {
  focus: () => extractModule(import('./focus-2aab0464.js')),
  hover: () => extractModule(import('./hover-23aa9f44.js')),
  listbox: () => extractModule(import('./listbox-51f914d2.js')),
  option: () => extractModule(import('./option-8df2906c.js')),
  active: () => extractModule(import('./active-b820d642.js')),
  fixate: () => extractModule(Promise.resolve().then(function () { return fixate; })),
  orient: () => extractModule(import('./orient-582d2f85.js')),
  popup: () => extractModule(import('./popup-182ebef0.js')),
  control: () => extractModule(import('./control-499146d3.js')),
  radiogroup: () => extractModule(import('./radiogroup-245f6863.js')),
  action: () => extractModule(import('./action-7c5b87af.js')),
  label: () => extractModule(import('./label-a1cdc048.js')),
  code: () => extractModule(import('./code-649560c9.js')),
  markdown: () => extractModule(import('./markdown-36de2b3e.js')),
  datetime: () => extractModule(import('./datetime-43fed83f.js')),
  number: () => extractModule(import('./number-569a4080.js')),
  slider: () => extractModule(import('./slider-69c3cd00.js')),
  numinput: () => extractModule(import('./numinput-724f9048.js')),
  input: () => extractModule(import('./input-a73b046b.js')),
  textarea: () => extractModule(import('./textarea-94f944e8.js')),
  fileinput: () => extractModule(import('./fileinput-7de0c444.js')),
  icon: () => extractModule(import('./icon-2c838791.js')),
  svg: () => extractModule(import('./svg-b77b3ad6.js')),
  image: () => extractModule(import('./image-7fdfba43.js')),
  debug: () => extractModule(import('./debug-676eb276.js')),
  debugger: () => extractModule(import('./debugger-ff8aebbf.js')),
  form: () => extractModule(import('./form-7b0ff0bf.js')),
  validator: () => extractModule(import('./validator-22a8ce7c.js')),
  group: () => Promise.resolve(GroupBehavior),
  tooltip: () => extractModule(import('./tooltip-a5f3ef88.js')),
  progressbar: () => extractModule(import('./progressbar-4e7ae3f0.js')),
  value: () => extractModule(import('./value-df025f56.js')),
  datepicker: () => extractModule(import('./datepicker-335a7ed2.js')),
  dateinput: () => extractModule(import('./dateinput-d457bba0.js')),
  inputgroup: () => extractModule(import('./inputgroup-a0096797.js')),
  menu: () => extractModule(import('./menu-f807f92f.js')),
  menuitem: () => extractModule(import('./menuitem-667a332b.js')),
  offset: () => extractModule(import('./offset-79fe60ed.js')),
  appear: () => extractModule(import('./appear-8c9465a9.js')),
  hotkey: () => extractModule(import('./hotkey-ae4f140f.js')),
  current: () => extractModule(import('./current-1924b31f.js')),
};

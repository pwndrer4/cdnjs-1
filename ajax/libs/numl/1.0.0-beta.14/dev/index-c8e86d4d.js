...
const SUCCESS_THEME = createThemeConfig({ name: 'success', hue: 140, type: 'tint', mods: 'tint' });
const DANGER_THEME = createThemeConfig({ name: 'danger', hue: 14, type: 'tint', mods: 'tint' });
const WARNING_THEME = createThemeConfig({ name: 'warning', hue: 35, type: 'tint', mods: 'tint' });
const THEME_MAP = {
...
const BEHAVIORS = {
  focus: () => extractModule(import('./focus-095bda55.js')),
  hover: () => extractModule(import('./hover-1bd9923b.js')),
  listbox: () => extractModule(import('./listbox-3097bead.js')),
  option: () => extractModule(import('./option-d79d130e.js')),
  active: () => extractModule(import('./active-ae01fd88.js')),
  fixate: () => extractModule(Promise.resolve().then(function () { return fixate; })),
  orient: () => extractModule(import('./orient-7e1392ce.js')),
  popup: () => extractModule(import('./popup-dcaa03a0.js')),
  control: () => extractModule(import('./control-962dea4a.js')),
  radiogroup: () => extractModule(import('./radiogroup-af5ce3b6.js')),
  action: () => extractModule(import('./action-64d33ec8.js')),
  label: () => extractModule(import('./label-a71dedd1.js')),
  code: () => extractModule(import('./code-2e6ec04e.js')),
  markdown: () => extractModule(import('./markdown-2fcf1b73.js')),
  datetime: () => extractModule(import('./datetime-02e24779.js')),
  number: () => extractModule(import('./number-0218682a.js')),
  slider: () => extractModule(import('./slider-5b4c538f.js')),
  numinput: () => extractModule(import('./numinput-5d4a7af4.js')),
  input: () => extractModule(import('./input-1b260219.js')),
  textarea: () => extractModule(import('./textarea-c45c8af1.js')),
  fileinput: () => extractModule(import('./fileinput-9d341b8f.js')),
  icon: () => extractModule(import('./icon-18377b25.js')),
  svg: () => extractModule(import('./svg-d9a1f85b.js')),
  image: () => extractModule(import('./image-cc5dace4.js')),
  debug: () => extractModule(import('./debug-3e35875d.js')),
  debugger: () => extractModule(import('./debugger-db2bdccc.js')),
  form: () => extractModule(import('./form-1b42b261.js')),
  validator: () => extractModule(import('./validator-fb183597.js')),
  group: () => Promise.resolve(GroupBehavior),
  tooltip: () => extractModule(import('./tooltip-20cd2b9b.js')),
  progressbar: () => extractModule(import('./progressbar-c350f8ff.js')),
  value: () => extractModule(import('./value-beb62d99.js')),
  datepicker: () => extractModule(import('./datepicker-56f87a99.js')),
  dateinput: () => extractModule(import('./dateinput-a50b7b8e.js')),
  inputgroup: () => extractModule(import('./inputgroup-9314fff4.js')),
  menu: () => extractModule(import('./menu-8a505a82.js')),
  menuitem: () => extractModule(import('./menuitem-bf8c398d.js')),
  offset: () => extractModule(import('./offset-64704f5b.js')),
  appear: () => extractModule(import('./appear-f77bed61.js')),
  hotkey: () => extractModule(import('./hotkey-70ab1d76.js')),
  current: () => extractModule(import('./current-f1e99518.js')),
};

...
const BEHAVIORS = {
  focus: () => extractModule(import('./focus-106ecbbd.js')),
  hover: () => extractModule(import('./hover-43091316.js')),
  listbox: () => extractModule(import('./listbox-17789889.js')),
  option: () => extractModule(import('./option-667d84f7.js')),
  active: () => extractModule(import('./active-186f9148.js')),
  fixate: () => extractModule(Promise.resolve().then(function () { return fixate; })),
  orient: () => extractModule(import('./orient-bda887ab.js')),
  popup: () => extractModule(import('./popup-8e46c700.js')),
  control: () => extractModule(import('./control-07e0c074.js')),
  radiogroup: () => extractModule(import('./radiogroup-07502f01.js')),
  action: () => extractModule(import('./action-39a41874.js')),
  label: () => extractModule(import('./label-bc4a4638.js')),
  code: () => extractModule(import('./code-8cac2987.js')),
  markdown: () => extractModule(import('./markdown-242c5046.js')),
  datetime: () => extractModule(import('./datetime-918d8b71.js')),
  number: () => extractModule(import('./number-f34de0ae.js')),
  slider: () => extractModule(import('./slider-bf6cd3c5.js')),
  numinput: () => extractModule(import('./numinput-d4150c2b.js')),
  input: () => extractModule(import('./input-10b97635.js')),
  textarea: () => extractModule(import('./textarea-ca4fce56.js')),
  fileinput: () => extractModule(import('./fileinput-92a4ce71.js')),
  icon: () => extractModule(import('./icon-131094a0.js')),
  svg: () => extractModule(import('./svg-57f6b641.js')),
  image: () => extractModule(import('./image-dba78007.js')),
  debug: () => extractModule(import('./debug-72410f6d.js')),
  debugger: () => extractModule(import('./debugger-05ab88fd.js')),
  form: () => extractModule(import('./form-bbb4120b.js')),
  validator: () => extractModule(import('./validator-3dfde143.js')),
  group: () => Promise.resolve(GroupBehavior),
  tooltip: () => extractModule(import('./tooltip-6626542b.js')),
  progressbar: () => extractModule(import('./progressbar-3c74a55b.js')),
  value: () => extractModule(import('./value-e4f552c4.js')),
  datepicker: () => extractModule(import('./datepicker-9d2ae195.js')),
  dateinput: () => extractModule(import('./dateinput-f5da7822.js')),
  inputgroup: () => extractModule(import('./inputgroup-ebfc2ebd.js')),
  menu: () => extractModule(import('./menu-4946d03e.js')),
  menuitem: () => extractModule(import('./menuitem-fdf9e7c5.js')),
  offset: () => extractModule(import('./offset-4e20b760.js')),
  appear: () => extractModule(import('./appear-3c405ca0.js')),
  hotkey: () => extractModule(import('./hotkey-e36f2d33.js')),
  current: () => extractModule(import('./current-65f4ecd6.js')),
};

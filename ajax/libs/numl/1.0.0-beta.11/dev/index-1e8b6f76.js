...
const BEHAVIORS = {
  focus: () => extractModule(import('./focus-6112aed4.js')),
  hover: () => extractModule(import('./hover-f0a40c25.js')),
  listbox: () => extractModule(import('./listbox-589d0f75.js')),
  option: () => extractModule(import('./option-47b094e3.js')),
  active: () => extractModule(import('./active-bbfa3e07.js')),
  fixate: () => extractModule(Promise.resolve().then(function () { return fixate; })),
  orient: () => extractModule(import('./orient-de7cf160.js')),
  popup: () => extractModule(import('./popup-ac8bf86d.js')),
  control: () => extractModule(import('./control-3b94497a.js')),
  radiogroup: () => extractModule(import('./radiogroup-b63ed803.js')),
  action: () => extractModule(import('./action-2e4f33e8.js')),
  label: () => extractModule(import('./label-add24d08.js')),
  code: () => extractModule(import('./code-9bbf47ee.js')),
  markdown: () => extractModule(import('./markdown-2ff3ea96.js')),
  datetime: () => extractModule(import('./datetime-72051911.js')),
  number: () => extractModule(import('./number-96b94eb8.js')),
  slider: () => extractModule(import('./slider-c9816119.js')),
  numinput: () => extractModule(import('./numinput-b22c8988.js')),
  input: () => extractModule(import('./input-0d9ed049.js')),
  textarea: () => extractModule(import('./textarea-943eeafa.js')),
  fileinput: () => extractModule(import('./fileinput-30f11cd7.js')),
  icon: () => extractModule(import('./icon-cc7b34b0.js')),
  svg: () => extractModule(import('./svg-d98d15ca.js')),
  image: () => extractModule(import('./image-f0b005ca.js')),
  debug: () => extractModule(import('./debug-5184ac52.js')),
  debugger: () => extractModule(import('./debugger-77b66aae.js')),
  form: () => extractModule(import('./form-6dd8e343.js')),
  validator: () => extractModule(import('./validator-d29732b6.js')),
  group: () => Promise.resolve(GroupBehavior),
  tooltip: () => extractModule(import('./tooltip-905b3ac7.js')),
  progressbar: () => extractModule(import('./progressbar-16f1a88d.js')),
  value: () => extractModule(import('./value-cb860e41.js')),
  datepicker: () => extractModule(import('./datepicker-aee7289a.js')),
  dateinput: () => extractModule(import('./dateinput-ef089774.js')),
  inputgroup: () => extractModule(import('./inputgroup-6ef3b548.js')),
  menu: () => extractModule(import('./menu-a240d360.js')),
  menuitem: () => extractModule(import('./menuitem-4a7e4d60.js')),
  offset: () => extractModule(import('./offset-99abab29.js')),
  appear: () => extractModule(import('./appear-a63e5173.js')),
  hotkey: () => extractModule(import('./hotkey-4926bb2e.js')),
  current: () => extractModule(import('./current-883e6e47.js')),
};

...
const BEHAVIORS = {
  focus: () => extractModule(import('./focus-267348c7.js')),
  hover: () => extractModule(import('./hover-9029d606.js')),
  listbox: () => extractModule(import('./listbox-dbffd305.js')),
  option: () => extractModule(import('./option-c23ff6eb.js')),
  active: () => extractModule(import('./active-d31d07c9.js')),
  fixate: () => extractModule(Promise.resolve().then(function () { return fixate; })),
  orient: () => extractModule(import('./orient-1dde248c.js')),
  popup: () => extractModule(import('./popup-6780833b.js')),
  control: () => extractModule(import('./control-4009b968.js')),
  radiogroup: () => extractModule(import('./radiogroup-ce28ae43.js')),
  action: () => extractModule(import('./action-5c27668f.js')),
  label: () => extractModule(import('./label-cb13c6a3.js')),
  code: () => extractModule(import('./code-549f85c1.js')),
  markdown: () => extractModule(import('./markdown-c5831f5a.js')),
  datetime: () => extractModule(import('./datetime-ef2cb860.js')),
  number: () => extractModule(import('./number-31d2b0b5.js')),
  slider: () => extractModule(import('./slider-ea52fec2.js')),
  numinput: () => extractModule(import('./numinput-7ac1532d.js')),
  input: () => extractModule(import('./input-ebfa2a37.js')),
  textarea: () => extractModule(import('./textarea-8c3981cd.js')),
  fileinput: () => extractModule(import('./fileinput-3579f0e7.js')),
  icon: () => extractModule(import('./icon-24963360.js')),
  svg: () => extractModule(import('./svg-141a4c11.js')),
  image: () => extractModule(import('./image-a7775362.js')),
  debug: () => extractModule(import('./debug-2d1814a3.js')),
  debugger: () => extractModule(import('./debugger-16af4274.js')),
  form: () => extractModule(import('./form-c38b5108.js')),
  validator: () => extractModule(import('./validator-bfb94e12.js')),
  group: () => Promise.resolve(GroupBehavior),
  tooltip: () => extractModule(import('./tooltip-6fa2e4de.js')),
  progressbar: () => extractModule(import('./progressbar-b89fc820.js')),
  value: () => extractModule(import('./value-64383b4a.js')),
  datepicker: () => extractModule(import('./datepicker-7a335491.js')),
  dateinput: () => extractModule(import('./dateinput-0daf0eee.js')),
  inputgroup: () => extractModule(import('./inputgroup-4ec5d1d2.js')),
  menu: () => extractModule(import('./menu-c84c7484.js')),
  menuitem: () => extractModule(import('./menuitem-e8171359.js')),
  offset: () => extractModule(import('./offset-c384b1ff.js')),
  appear: () => extractModule(import('./appear-b5b7b943.js')),
  hotkey: () => extractModule(import('./hotkey-ec1f3989.js')),
  current: () => extractModule(import('./current-fad5af40.js')),
};

  ...
  loadImageShape(container, imageShape) {
    return ImageDrawer_awaiter(this, void 0, void 0, function* () {
      try {
        ...
        this.addImage(container, yield imagePromise);
      } catch (_a) {
...
class Canvas {
  ...
  drawOrbit(particle, orbitOptions, type) {
    ...
    CanvasUtils.drawEllipse(this.context, particle, orbitOptions.color || particle.getFillColor(), (_a = particle.orbitRadius) !== null && _a !== void 0 ? _a : particle.getRadius(), orbitOptions.opacity, orbitOptions.width, particle.orbitRotation || orbitOptions.rotation.value, start, end);
  }
...
class Mover {
  ...
  moveParticle(delta) {
    ...
    if (particlesOptions.move.spin.enable && particle.spinRadius !== undefined && particle.spinAngle !== undefined && particle.spinCenter !== undefined && particle.spinDirection !== undefined && particle.spinAcceleration !== undefined) {
      const updateFunc = {
  ...
  applyDistance() {
    ...
    if ((hDistance !== undefined && dxFixed >= hDistance || vDistance !== undefined && dyFixed >= vDistance) && !particle.misplaced) {
      ...
      if (hDistance !== undefined && (particle.position.x < initialPosition.x && particle.velocity.horizontal < 0 || particle.position.x > initialPosition.x && particle.velocity.horizontal > 0)) {
        particle.velocity.horizontal *= -Math.random();
      }

      if (vDistance !== undefined && (particle.position.y < initialPosition.y && particle.velocity.vertical < 0 || particle.position.y > initialPosition.y && particle.velocity.vertical > 0)) {
  ...
  getProximitySpeedFactor() {
    const container = this.container;
    const options = container.options;
    const active = Utils.isInArray("slow", options.interactivity.events.onHover.mode);
...
class OutOfCanvasUpdater {
  ...
  bounce(delta, direction, outMode) {
    const container = this.container,
          particle = this.particle;
    let handled = false;
  ...
  emit() {
    ...
    for (let i = 0; i < this.emitterOptions.rate.quantity; i++) {
      ...
      if (this.spawnColor !== undefined) {
        ...
        if (colorAnimation === null || colorAnimation === void 0 ? void 0 : colorAnimation.enable) {
          ...
          this.spawnColor.h += ((_b = colorAnimation.speed) !== null && _b !== void 0 ? _b : 0) * container.fpsLimit / emitFactor + offset * 3.6;

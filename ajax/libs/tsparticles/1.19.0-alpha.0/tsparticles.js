...
// CONCATENATED MODULE: ./dist/browser/Enums/OrbitType.js
var OrbitType;
...
class Canvas {
  ...
  drawParticle(particle, delta) {
    ...
    if (radius > 0) {
      ...
      CanvasUtils.drawParticle(this.container, this.context, particle, delta, fillColorValue, strokeColorValue, options.backgroundMask.enable, options.backgroundMask.composite, radius * zSizeFactor, zOpacity, particle.particlesOptions.shadow);
  ...
  drawOrbit(particle, orbitOptions, type) {
    ...
    CanvasUtils.drawEllipse(this.context, particle, orbitOptions.color || particle.getFillColor(), (_a = particle.orbitRadiusValue) !== null && _a !== void 0 ? _a : particle.getRadius(), orbitOptions.opacity, orbitOptions.width, particle.orbitRotationValue || orbitOptions.rotation.value, start, end);
  }
...
// CONCATENATED MODULE: ./dist/browser/Options/Classes/Particles/Spin.js
;
class Spin {
  constructor() {
    this.enable = false;
...
class Mover {
  ...
  moveParticle(delta) {
    ...
    if (particlesOptions.move.vibrate) {
      this.moveXY(Math.sin(particle.position.x * Math.cos(particle.position.y)), Math.cos(particle.position.y * Math.sin(particle.position.x)));
    }
...
class Particle {
  constructor(id, container, position, overrideOptions, group) {
    ...
    if (this.particlesOptions.spin.enable) {
      const spinCenter = (_g = this.particlesOptions.spin.position) !== null && _g !== void 0 ? _g : {
        x: 50,
        y: 50
      };
      this.spinCenter = {
    ...
    if (sizeAnimation.enable) {
      ...
      this.size.velocity = ((_h = this.sizeAnimationSpeed) !== null && _h !== void 0 ? _h : container.retina.sizeAnimationSpeed) / 100 * container.retina.reduceFactor;
    ...
    if (orbitRotationOptions.enable) {
      this.orbitRotationValue = orbitRotationOptions.minimumValue ? Math.floor(Math.random() * 360) + orbitRotationOptions.minimumValue : Math.floor(Math.random() * 360);
    } else {
    ...
    this.strokeColor = {
      value: (_j = ColorUtils.colorToHsl(this.stroke.color)) !== null && _j !== void 0 ? _j : this.color.value
    };
...
class InteractionManager {
  constructor(container) {
    ...
    this.particleInteractors = [new Attractor(container), new Lighter(container), new Collider(container), new Infecter_Infecter(container), new Repulser_Repulser(container), new Linker(container)];
  }
...
class Particles_Particles {
  ...
  removeAt(index, quantity = 1, group) {
...
class EmitterInstance {
  ...
  emit() {
    ...
    if (this.spawnColor !== undefined) {
      const spawnColorAnimation = (_a = this.emitterOptions.spawnColor) === null || _a === void 0 ? void 0 : _a.animation;

      if (spawnColorAnimation === null || spawnColorAnimation === void 0 ? void 0 : spawnColorAnimation.enable) {
        const emitFactor = 1000 * this.emitterOptions.rate.delay / container.retina.reduceFactor;
        this.spawnColor.h += ((_b = spawnColorAnimation.speed) !== null && _b !== void 0 ? _b : 0) * container.fpsLimit / emitFactor;

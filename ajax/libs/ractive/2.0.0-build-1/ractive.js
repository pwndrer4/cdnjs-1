/*
	...
	Build: e832206323def293bb7b048d8f00bd20e21feaba
	Date: Sun Oct 25 2020 09:09:24 GMT+0000 (Coordinated Universal Time)
...
(function (TransitionTrigger) {
    TransitionTrigger["INTRO_OUTRO"] = "t0";
    TransitionTrigger["INTRO"] = "t1";
    TransitionTrigger["OUTRO"] = "t2";
...
var LinkModel = /** @class */ (function (_super) {
    ...
    LinkModel.prototype.attach = function (fragment) {
...
var Context = /** @class */ (function () {
    ...
    Context.prototype.unlink = function (dest) {
        ...
        if ('owner' in here && ((_a = here.owner) === null || _a === void 0 ? void 0 : _a._link))
            { here.owner.unlink(); }
        runloop.end();
        return promise;
    };
...
var RactiveModel = /** @class */ (function (_super) {
    ...
    RactiveModel.prototype.joinKey = function (key) {
        ...
        if ((key === 'root' || key === 'parent') && !(model instanceof LinkModel))
            ...
            { return this.ractive.constructor._cssModel; } // TODO remove this "workaround"
        return model;
    };
    return RactiveModel;
}(SharedModel));
...
var Decorator = /** @class */ (function () {
    ...
    Decorator.prototype.render = function () {
        ...
        runloop.scheduleTask(function () {
            ...
            _this.handle = fn.apply(ractive, [_this.node].concat(args));
...
var RepeatedFragment = /** @class */ (function () {
    ...
    RepeatedFragment.prototype.bind = function (context) {
        ...
        if (this.source)
            { this.source.model.unbind(this.source); }
    ...
    RepeatedFragment.prototype.rebound = function (update$$1) {
        ...
        this.iterations.forEach(function (f, i) {
            f.context = contextFor(_this, f, i);
            f.rebound(update$$1);
        });
    };

  ...
  _createClass(ConfirmPopup, [{
    ...
    value: function align() {
      if (this.props.target) {
        _DomHandler.default.absolutePosition(this.container, this.props.target);
        ...
        if (containerOffset.top < targetOffset.top) {
          _DomHandler.default.addClass(this.container, 'p-confirm-popup-flipped');
        }
      }
    }
  }, {

(function (global, factory) {
  ...
  */
  ...
  var isIos = navigator.userAgent.match(/iphone|ipad|ipod/i) || (navigator.userAgent.indexOf("Mac") !== -1 && "ontouchend" in document);
  var isMobile = !!(typeof navigator !== 'undefined' && (isIos || navigator.userAgent.match(/android/i)));
    ...
    methods: {
      ...
      _toggleAnswer: function _toggleAnswer(option) {
        ...
        if (this.isValid() && this.question.nextStepOnAnswer && !this.question.multiple) {
          setTimeout(function () { return this$1.$emit('next'); }, 350);
        }
      },

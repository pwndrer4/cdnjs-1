/*!
  * vue-i18n v9.0.0-beta.17
  * (c) 2020 kazuya kawaguchi
  * Released under the MIT License.
  */
import { isFunction, isObject, getGlobalThis, format, makeSymbol, isPlainObject, isArray, isBoolean, isString, isRegExp, isNumber, warn, isEmptyObject } from '@intlify/shared';
import { setupDevtoolsPlugin } from '@vue/devtools-api';
import { DevToolsLabels, DevToolsPlaceholders, DevToolsTimelineColors, createCompileError, createCoreContext, updateFallbackLocale, resolveValue, clearDateTimeFormat, clearNumberFormat, NOT_REOSLVED, parseTranslateArgs, translate, MISSING_RESOLVE_VALUE, parseDateTimeArgs, datetime, parseNumberArgs, number, createEmitter } from '@intlify/core-base';
        ...
        try {
            setupDevtoolsPlugin({
                ...
                api.on.walkComponentTree((payload, ctx) => {
                    updateComponentTreeDataTags(ctx.currentAppRecord, payload.componentTreeData);
                });
...
function updateComponentTreeDataTags(appRecord, treeData) {

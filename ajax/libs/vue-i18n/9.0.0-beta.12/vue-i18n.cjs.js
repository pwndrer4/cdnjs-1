...
function getWarnMessage$1(code, ...args) {
    return shared.format(warnMessages$1[code], ...args);
}

function createI18nError(code, ...args) {
    return messageCompiler.createCompileError(code, null,  { messages: errorMessages$1, args } );
}
    ...
    function wrapWithDeps(fn, argumentParser, warnType, fallbackSuccess, fallbackFail, successCondition) {
        ...
        if (shared.isNumber(ret) && ret === NOT_REOSLVED) {
            ...
            if ( _fallbackRoot && __root) {
                shared.warn(getWarnMessage$1(6 /* FALLBACK_TO_ROOT */, {
                    key,
                    type: warnType
                }));
                // for vue-devtools timeline event
...
function convertComposerOptions(options) {
    ...
    if ( options.formatter) {
        shared.warn(getWarnMessage$1(8 /* NOT_SUPPORTED_FORMATTER */));
    }
    if ( options.preserveDirectiveContent) {
        shared.warn(getWarnMessage$1(9 /* NOT_SUPPORTED_PRESERVE_DIRECTIVE */));
    }
...
function createVueI18n(options = {}) {
    ...
    const vueI18n = {
        ...
        getChoiceIndex(choice, choicesLength) {
                ...
                shared.warn(getWarnMessage$1(10 /* NOT_SUPPORTED_GET_CHOICE_INDEX */));
            return -1;
        },
        // for internal
...
function vTDirective(i18n) {
    const bind = (el, { instance, value, modifiers }) => {
        ...
        if ( modifiers.preserve) {
            shared.warn(getWarnMessage$1(7 /* NOT_SUPPORTED_PRESERVE */));
        }
...
function apply(app, i18n, ...options) {
    ...
    if ( globalInstall && useI18nComponentName) {
        shared.warn(getWarnMessage$1(11 /* COMPONENT_NAME_LEGACY_COMPATIBLE */, {
...
function useI18n(options = {}) {
    ...
    if (scope === 'parent') {
        ...
        if (composer == null) {
            {
                shared.warn(getWarnMessage$1(12 /* NOT_FOUND_PARENT_SCOPE */));
            }
            composer = global;
        }
        return composer;

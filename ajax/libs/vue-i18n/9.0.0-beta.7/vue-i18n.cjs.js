        ...
        beforeCreate() {
            ...
            if (options.i18n) {
                ...
                if (this === this.$root) {
                    ...
                    const messages = getLocaleMessages(rootLegacy.locale, {
                        messages: optionsI18n.messages,
                        __i18n: optionsI18n.__i18n
                    });
                    Object.keys(messages).forEach(locale => rootLegacy.mergeLocaleMessage(locale, messages[locale]));
                    if (optionsI18n.datetimeFormats) {
                        Object.keys(optionsI18n.datetimeFormats).forEach(locale => rootLegacy.mergeDateTimeFormat(locale, optionsI18n.datetimeFormats[locale]));
                    }
                    if (optionsI18n.numberFormats) {
                        Object.keys(optionsI18n.numberFormats).forEach(locale => rootLegacy.mergeNumberFormat(locale, optionsI18n.numberFormats[locale]));
                    }
                    this.$i18n = legacy;
                }
                else {

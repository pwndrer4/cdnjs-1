/*Type definitions for Survey JavaScript library v1.8.22
...
export declare class QuestionMatrixDynamicImplementor extends QuestionMatrixBaseImplementor {
    ...
    getKoPopupIsVisible(row: MatrixDropdownRowModelBase): ko.Observable<boolean>;
}
...
export declare class PopupViewModel {
    ...
    onShow: () => void;
    cssClass: string;
    top: ko.Observable<any>;
    left: ko.Observable<any>;
    popupDirection: ko.Observable<string>;
    pointerTarget: ko.Observable<object>;
    constructor(contentComponentName: string, contentComponentData: any, isVisible: ko.Observable<boolean>, verticalPosition: "top" | "bottom" | "middle", horizontalPosition: "left" | "right" | "center", showPointer: boolean, isModal: boolean, onCancel: () => void, onApply: () => void, onHide: () => void, onShow: () => void, cssClass: string, targetElement: HTMLElement);
...
/**
    ...
    */
export declare class ActionBarViewModel {
...
export declare class Question extends SurveyElement implements IQuestion, IConditionRunner, ILocalizableOwner, IValidatorOwner, ITitleOwner {
        ...
        protected getValueAndRunExpression(val: any, expression: string): any;
        /**
...
export declare class ActionBarItemViewModel {

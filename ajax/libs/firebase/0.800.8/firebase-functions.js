(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var FunctionsService = /** @class */ (function () {
         ...
         */
        function FunctionsService(app, authProvider, messagingProvider, region, fetchImpl) {
            var _this = this;
    ...
    function registerFunctions(fetchImpl) {
        var factory = function (container, region) {
            ...
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            return new FunctionsService(app, authProvider, messagingProvider, region, fetchImpl);
        };

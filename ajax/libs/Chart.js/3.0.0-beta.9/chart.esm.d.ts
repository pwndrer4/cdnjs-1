...
interface Plugin<O = {}> extends ExtendedPlugin {
	id: string;
...
export { ActiveDataPoint, ActiveElement, Animation, AnimationCommonSpec, AnimationEvent, AnimationOptions, AnimationPropertySpec, AnimationSpecContainer, Animations, Animator, AnyObject, ArcElement, ArcHoverOptions, ArcOptions, ArcProps, BarController, BarControllerChartOptions, BarControllerDatasetOptions, BarElement, BarHoverOptions, BarOptions, BarProps, BasePlatform, BasicPlatform, BorderRadius, BubbleController, BubbleControllerDatasetOptions, BubbleDataPoint, CartesianScaleOptions, CartesianScaleTypeRegistry, CategoryScale, CategoryScaleOptions, Chart, ChartArea, ChartComponent, ChartComponentLike, ChartConfiguration, ChartData, ChartDataset, ChartDatasetProperties, ChartEvent, ChartItem, ChartMeta, ChartOptions, ChartType, ChartTypeRegistry, Color, CommonHoverOptions, CommonOptions, ComplexFillTarget, ControllerDatasetOptions, CoreChartOptions, CoreInteractionOptions, CoreScaleOptions, DatasetChartOptions, DatasetController, DatasetControllerChartComponent, DateAdapter, DateAdapterBase, DeepPartial, DefaultDataPoint, Defaults, DistributiveArray, DomPlatform, DoughnutAnimationOptions, DoughnutController, DoughnutControllerChartOptions, DoughnutControllerDatasetOptions, DoughnutDataPoint, EasingFunction, Element, ElementChartOptions, ExtendedPlugin, FillTarget, Filler, FillerControllerDatasetOptions, FillerOptions, FontSpec, GridLineOptions, HoverInteractionOptions, Interaction, InteractionItem, InteractionMode, InteractionModeFunction, InteractionModeMap, InteractionOptions, LayoutItem, LayoutPosition, Legend, LegendElement, LegendItem, LegendOptions, LineController, LineControllerChartOptions, LineControllerDatasetOptions, LineElement, LineHoverOptions, LineOptions, LineProps, LinearScale, LinearScaleOptions, LogarithmicScale, LogarithmicScaleOptions, ParsingOptions, PieAnimationOptions, PieController, PieControllerChartOptions, PieControllerDatasetOptions, PieDataPoint, Plugin, PluginOptions, Point, PointElement, PointHoverOptions, PointOptions, PointPrefixedHoverOptions, PointPrefixedOptions, PointProps, PointStyle, PolarAreaAnimationOptions, PolarAreaController, PolarAreaControllerChartOptions, PolarAreaControllerDatasetOptions, RadarController, RadarControllerChartOptions, RadarControllerDatasetOptions, RadialLinearScale, RadialLinearScaleOptions, RadialScaleTypeRegistry, Registry, Scale, ScaleChartOptions, ScaleOptions, ScaleType, ScaleTypeRegistry, ScatterController, ScatterControllerChartOptions, ScatterControllerDatasetOptions, ScatterDataPoint, Scriptable, ScriptableAndArray, ScriptableAndArrayOptions, ScriptableContext, ScriptableOptions, ScriptableScaleContext, Segment, TextAlign, Tick, TickOptions, Ticks, TimeScale, TimeScaleOptions, TimeSeriesScale, TimeUnit, Title, TitleOptions, Tooltip, TooltipAlignment, TooltipCallbacks, TooltipItem, TooltipModel, TooltipOptions, TypedRegistry, UpdateMode, UpdateModeEnum, VisualElement, _adapters, defaults, layouts, registry };

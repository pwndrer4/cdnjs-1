...
var ObserveDOM$1 = /** @class */ (function () {
    function ObserveDOM(scroll) {
        this.scroll = scroll;
        this.refreshTimer = 0;
        this.init();
    ...
    ObserveDOM.prototype.handleOptions = function (userOptions) {
        if (userOptions === void 0) { userOptions = {}; }
        userOptions = (userOptions === true ? {} : userOptions);
        var defaultOptions = {
            debounceTime: 100,
    ...
    ObserveDOM.prototype.bindEventsToWrapper = function () {
    ...
    ObserveDOM.prototype.load = function (e) {
        var _this = this;
        var target = e.target;
    ...
    ObserveDOM.pluginName = 'observeImage';
    return ObserveDOM;
}());
...
export { Behavior, CustomOptions, InfinityScroll, MouseWheel, Movable, NestedScroll, ObserveDOM as ObserveDom, ObserveDOM$1 as ObserveImage, PullDown as PullDownRefresh, PullUp as PullUpLoad, ScrollBar, Slide, Wheel, Zoom, createBScroll };

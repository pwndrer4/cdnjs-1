(function (global, factory) {
...
}(typeof self !== 'undefined' ? self : this, function (exports,Chart) { 'use strict';
  ...
  var defaults = Object.assign({}, Chart.defaults.global.elements.rectangle, {
    borderWidth: 1,
    outlierRadius: 2,
  ...
  var array = {
    ...
    updateElement: function updateElement(elem, index, reset) {
      ...
      ['outlierRadius', 'itemRadius', 'itemStyle', 'itemBackgroundColor', 'itemBorderColor', 'outlierColor', 'hitPadding'].forEach(function (item) {
  ...
  var boxplot = Object.assign({}, array, {
  ...
  var controller = Object.assign({}, array, {

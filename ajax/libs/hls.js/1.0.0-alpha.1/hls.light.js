...
function setStreamingMode(config, allowProgressive) {
  ...
  if (allowProgressive && canStreamProgressively) {
    ...
    config.loader = _utils_xhr_loader__WEBPACK_IMPORTED_MODULE_5__["default"];
    config.progressive = false;
    _utils_logger__WEBPACK_IMPORTED_MODULE_8__["logger"].log('[config]: Progressive streaming disabled, using XhrLoader');
  }
}

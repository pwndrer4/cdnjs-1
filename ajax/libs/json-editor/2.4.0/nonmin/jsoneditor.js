...
var JSONEditor = /*#__PURE__*/function () {
  function JSONEditor(element) {
    ...
    var rules = Object(_utilities_js__WEBPACK_IMPORTED_MODULE_7__["extend"])(_style_css_js__WEBPACK_IMPORTED_MODULE_11__["default"], this.getEditorsRules());
    ...
    var addRules = function addRules(themeName, rules, shadowRoot) {
      return shadowRoot ? _this.addNewStyleRulesToShadowRoot(themeName, rules, shadowRoot) : _this.addNewStyleRules(themeName, rules);
    };
  ...
  _createClass(JSONEditor, [{
    ...
    value: function addNewStyleRules(themeName, rules) {
      ...
      Object.keys(rules).forEach(function (selector) {
        var sel = themeName === 'default' ? selector : "".concat(qualifier, "[data-theme=\"").concat(themeName, "\"] ").concat(selector); // all browsers, except IE before version 9
    ...
    value: function addNewStyleRulesToShadowRoot(themeName, rules, shadowRoot) {
      ...
      var cssText = '';
      Object.keys(rules).forEach(function (selector) {
        var sel = themeName === 'default' ? selector : "".concat(qualifier, "[data-theme=\"").concat(themeName, "\"] ").concat(selector);
    ...
    value: function checkDependency(path, choices) {
      ...
      if (!editor || !editor.dependenciesFulfilled) {
        ...
        choices.some(function (choice) {
          if (value === choice) {
            _this3.dependenciesFulfilled = true;
            return true;
          }
        });
    ...
    value: function setupWatchListeners() {
      ...
      if (Object(_utilities_js__WEBPACK_IMPORTED_MODULE_0__["hasOwnProperty"])(this.schema, 'watch')) {
        ...
        Object.keys(this.schema.watch).forEach(function (name) {
          ...
          if (first === '#') first = _this5.jsoneditor.schema.id || 'root';
    ...
    value: function destroy() {
      ...
      if (this.watched) {
        Object.values(this.watched).forEach(function (adjustedPath) {
          return _this7.jsoneditor.unwatch(adjustedPath, _this7.watch_listener);
        });
      }
      ...
      if (this.schema.options && this.schema.options.inputAttributes) {
        ...
        Object.keys(inputAttributes).forEach(function (key) {
          if (!protectedAttributes.includes(key.toLowerCase())) {
            _this8.input.setAttribute(key, inputAttributes[key]);
          }
        });
      }
    }
...
var ArrayEditor = /*#__PURE__*/function (_AbstractEditor) {
  ...
  _createClass(ArrayEditor, [{
    ...
    key: "setVisibility",
    value: function setVisibility(element, display) {
    ...
    value: function setupButtons(minItems) {
      ...
      if (!this.value.length) {
        ...
        this.setVisibility(this.delete_last_row_button, _display);
      ...
      if (oldi !== this.value.length || force) {
        ...
        this.rows.forEach(function (editor, i) {
          ...
          if (editor.movedown_button) {
            ...
            _this6.setVisibility(editor.movedown_button, display);
          }
          /* Hide the delete button if we have minItems items */


          if (editor.delete_button) {
            _this6.setVisibility(editor.delete_button, !minItems);
          }
          /* Get the value for this editor */
    ...
    value: function _createDeleteButton(i, holder) {
      ...
      var button = this.getButton(this.getItemTitle(), 'delete', this.translate('button_delete_row_title', [this.getItemTitle()]));
    ...
    value: function _createCopyButton(i, holder) {
      ...
      var button = this.getButton(this.getItemTitle(), 'copy', "Copy ".concat(this.getItemTitle()));
    ...
    value: function _createMoveUpButton(i, holder) {
      ...
      var button = this.getButton('', this.schema.format === 'tabs-top' ? 'moveleft' : 'moveup', this.translate('button_move_up_title'));
    ...
    value: function _createMoveDownButton(i, holder) {
      ...
      var button = this.getButton('', this.schema.format === 'tabs-top' ? 'moveright' : 'movedown', this.translate('button_move_down_title'));
    ...
    value: function _createToggleButton() {
      ...
      var button = this.getButton('', 'collapse', this.translate('button_collapse'));
      ...
      button.addEventListener('click', function (e) {
        e.preventDefault();
        e.stopPropagation();
        if (_this12.panel) _this12.setVisibility(_this12.panel, _this12.collapsed);
        ...
        if (_this12.collapsed) {
          ...
          _this12.setButtonText(e.currentTarget, '', 'collapse', _this12.translate('button_collapse'));
        } else {
          _this12.collapsed = true;
          _this12.row_holder.style.display = 'none';
          _this12.controls.style.display = 'none';

          _this12.setButtonText(e.currentTarget, '', 'expand', _this12.translate('button_expand'));
        }
      });
      return button;
    }
    ...
    value: function _createAddRowButton() {
      ...
      var button = this.getButton(this.getItemTitle(), 'add', this.translate('button_add_row_title', [this.getItemTitle()]));
    ...
    value: function _createDeleteLastRowButton() {
      ...
      var button = this.getButton(this.translate('button_delete_last', [this.getItemTitle()]), 'subtract', this.translate('button_delete_last_title', [this.getItemTitle()]));
    ...
    value: function _createRemoveAllRowsButton() {
      ...
      var button = this.getButton(this.translate('button_delete_all'), 'delete', this.translate('button_delete_all_title'));
...
var IntegerEditor = /*#__PURE__*/function (_NumberEditor) {
  ...
  _createClass(IntegerEditor, [{
    ...
    value: function getValue() {
      ...
      var value = Object(_utilities_js__WEBPACK_IMPORTED_MODULE_1__["isInteger"])(this.value) ? parseInt(this.value) : this.value;
...
var NumberEditor = /*#__PURE__*/function (_StringEditor) {
  ...
  _createClass(NumberEditor, [{
    ...
    value: function getValue() {
      ...
      var value = Object(_utilities__WEBPACK_IMPORTED_MODULE_1__["isNumber"])(this.value) ? parseFloat(this.value) : this.value;
    ...
    value: function setValue(value, initial) {
      ...
      Object.entries(value).forEach(function (_ref9) {
        ...
        if (!_this12.cached_editors[i]) {
          ...
          if (_this12.editors[i]) _this12.editors[i].setValue(val, initial, !!_this12.editors[i].template);
        }
      });
      this.refreshValue();
      this.layoutEditors();
...
var TableEditor = /*#__PURE__*/function (_ArrayEditor) {
  ...
  _createClass(TableEditor, [{
    ...
    value: function refreshRowButtons() {
      ...
      this.rows.forEach(function (editor, i) {
        if (editor.delete_button) {
          ...
          _this2.setVisibility(editor.delete_button, display);
        ...
        if (editor.copy_button) {
          ...
          _this2.setVisibility(editor.copy_button, _display);
        ...
        if (editor.moveup_button) {
          ...
          _this2.setVisibility(editor.moveup_button, _display2);
        ...
        if (editor.movedown_button) {
          ...
          _this2.setVisibility(editor.movedown_button, _display3);
      ...
      this.rows.forEach(function (editor) {
        return _this2.setVisibility(editor.controls_cell, need);
      });
    ...
    value: function _createDeleteButton(i, holder) {
      ...
      var button = this.getButton('', 'delete', this.translate('button_delete_row_title_short'));
      button.classList.add('delete', 'json-editor-btntype-delete');
      button.setAttribute('data-i', i);
      button.addEventListener('click', function (e) {
        e.preventDefault();
    ...
    value: function _createCopyButton(i, holder) {
      ...
      var button = this.getButton('', 'copy', this.translate('button_copy_row_title_short'));
      button.classList.add('copy', 'json-editor-btntype-copy');
      button.setAttribute('data-i', i);
      button.addEventListener('click', function (e) {
        e.preventDefault();
    ...
    value: function _createMoveUpButton(i, holder) {
      ...
      var button = this.getButton('', 'moveup', this.translate('button_move_up_title'));
      button.classList.add('moveup', 'json-editor-btntype-move');
      button.setAttribute('data-i', i);
      button.addEventListener('click', function (e) {
        e.preventDefault();
    ...
    value: function _createMoveDownButton(i, holder) {
      ...
      var button = this.getButton('', 'movedown', this.translate('button_move_down_title'));
      button.classList.add('movedown', 'json-editor-btntype-move');
      button.setAttribute('data-i', i);
      button.addEventListener('click', function (e) {
        e.preventDefault();
    ...
    value: function addControls() {
      ...
      if (this.title_controls) {
        ...
        this.toggle_button.addEventListener('click', function (e) {
          ...
          _this8.setVisibility(_this8.panel, _this8.collapsed);

          if (_this8.collapsed) {
            _this8.collapsed = false;

            _this8.setButtonText(e.currentTarget, '', 'collapse', _this8.translate('button_collapse'));
          } else {
            _this8.collapsed = true;

            _this8.setButtonText(e.currentTarget, '', 'expand', _this8.translate('button_expand'));
          }
        });
        /* If it should start collapsed */
...
var SchemaLoader = /*#__PURE__*/function () {
  ...
  _createClass(SchemaLoader, [{
    ...
    value: function _isLocalUrl(url, fileBase) {
      return fileBase !== url.substr(0, fileBase.length) && url.substr(0, 4) !== 'http' && url.substr(0, 5) !== 'blob:' && url.substr(0, 5) !== 'data:' && url.substr(0, 1) !== '/';
    }
  }, {
...
var AbstractTheme = /*#__PURE__*/function () {
  ...
  _createClass(AbstractTheme, [{
    ...
    value: function getTabHolder(propertyName) {
      ...
      var el = document.createElement('div');
      el.innerHTML = "<div class='je-tabholder tabs'></div><div class='content' id='".concat(pName, "'></div><div class='je-tabholder--clear'></div>");
      return el;
    }
  }, {
    key: "getTopTabHolder",
    value: function getTopTabHolder(propertyName) {
      var pName = typeof propertyName === 'undefined' ? '' : propertyName;
      var el = document.createElement('div');
      el.innerHTML = "<div class='tabs je-tabholder--top'></div><div class='je-tabholder--clear'></div><div class='content' id='".concat(pName, "'></div>");
      return el;
    }
  }, {
    key: "applyStyles",
  ...
  _createClass(Validator, [{
    ...
    value: function _validateSchema(schema, value, path) {
      ...
      if (['uuid'].includes(schema.format)) {
        errors.push.apply(errors, _toConsumableArray(this._validateUUIDSchema(schema, value, path)));
      }
      /* custom validator */
    ...
    value: function _validateUUIDSchema(schema, value, path) {

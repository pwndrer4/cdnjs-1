    ...
    var RippledComponent = function (_Component) {
      ...
      _createClass(RippledComponent, [{
          ...
          if (this.rippleShouldTrigger(isTouch)) {
            (function () {
              ...
              _this3.setState({ ripples: ripples }, function () {
                if (_this3.refs[key]) _this3.refs[key].offsetWidth; //eslint-disable-line no-unused-expressions
        ...
        value: function render() {
          ...
          var childProps = _extends({ onMouseDown: this.handleMouseDown, onTouchStart: this.handleTouchStart }, other);
